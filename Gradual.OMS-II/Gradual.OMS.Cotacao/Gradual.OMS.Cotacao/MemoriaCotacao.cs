...
namespace Gradual.OMS.Cotacao
{
    ...
    public static class MemoriaCotacao
    {
        ...
        public static Hashtable hstCotacoesIndiceGradual = new Hashtable();
        ...
        public static void AdicionarNegocioIndiceGradual(string Instrumento, string Mensagem)
        {
            try
            {
                ...
                if (status == 2)
                {
                    lock (hstCotacoesIndiceGradual)
                    {

                        if (hstCotacoesIndiceGradual[Instrumento] == null)
                        {
                            hstCotacoesIndiceGradual.Add(Instrumento, Mensagem);
                        }
                        else
                        {
                            hstCotacoesIndiceGradual[Instrumento] = Mensagem;
                        }
                    }
                }
            }
