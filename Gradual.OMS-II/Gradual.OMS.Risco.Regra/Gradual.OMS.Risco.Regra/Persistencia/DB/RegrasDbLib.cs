...
namespace Gradual.OMS.Risco.Regra.Persistencia.DB
{
    /// <summary>
    ...
    public class RegrasDbLib 
    {
        ...
        public RegrasDbLib(string pNomeDaConexao)
        {
        ...
        protected virtual SqlConnection OnReceberConexao()
        {
            ...
            if (_cn == null)
            {
                ...
                _cn = new SqlConnection(
                    ConfigurationManager.ConnectionStrings[this.gNomeDaConexao].ConnectionString);
