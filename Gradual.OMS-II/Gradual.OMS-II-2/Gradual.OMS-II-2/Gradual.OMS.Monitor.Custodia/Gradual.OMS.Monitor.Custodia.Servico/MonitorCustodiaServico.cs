...
namespace Gradual.OMS.Monitor.Custodia.Servico
{
    ...
    public class MonitorCustodiaServico : IServicoMonitorCustodia, IServicoControlavel
    {
        ...
        private Thread thThreadPositionGlobal;
        ...
        private MonitorPositionGlobalGradulaInfo gPositionGlobalGradual               = new MonitorPositionGlobalGradulaInfo();
        private Hashtable htOrderOpcao                                                = new Hashtable();
        #endregion
        ...
        /// <summary>
        /// Thread Gerencimanento de clientes 
        /// </summary>
        ...
        public MonitorCustodiaInfo CalcularPosicaoCustodia(int idCliente)
        {
            ...
            try
            {
                ...
                List<MonitorCustodiaInfo.CustodiaPosicao> lPosicaoCustodiaSemCarteira = MonitorCustodiaDB.ConsultarCustodiaNormalSemCarteira(new Lib.Mensageria.MonitorCustodiaRequest() { CodigoCliente = lRetorno.CodigoClienteBov, CodigoClienteBmf = lRetorno.CodigoClienteBmf });
