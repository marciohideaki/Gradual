...
{
    public partial class frmCallbackRouter : Form, IRoteadorOrdensCallback
    {
        public frmCallbackRouter()
        {
            InitializeComponent();
        }
        ...
        private void frmCallbackRouter_Load(object sender, EventArgs e)
        {
        ...
        private void TratarNotificacaoExecucao(object _CodigoCliente)
        {
            try
            {
                ...
                if (PermissaoAlavancagemOperacional > 0)
                {
                    ...
                    if ((CodigoClienteOrigem == 31940) || (CodigoClienteOrigem == 42089))
                    {
                        ...
                        logger.Info("Cliente codigo: " + CodigoClienteOrigem.ToString());
        ...
        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensResponse BuscarOrdens(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensRequest pRequest)
        {
            throw new NotImplementedException();
        }

        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensResponse BuscarOrdensSinacor(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensRequest pRequest)
        {
            throw new NotImplementedException();
        }

        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensStopStartResponse BuscarOrdensStopStart(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.BuscarOrdensStopStartRequest pRequest)
        {
            throw new NotImplementedException();
        }

        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.InformarLoginDoClienteResponse InformarLoginDoCliente(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.InformarLoginDoClienteRequest pRequest)
        {
            throw new NotImplementedException();
        }

        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.InformarLogoutDoClienteResponse InformarLogoutDoCliente(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.InformarLogoutDoClienteRequest pRequest)
        {
            throw new NotImplementedException();
        }

        public Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.VerificarStatusDasOrdensResponse VerificarStatusDasOrdens(Gradual.OMS.AcompanhamentoOrdens.Lib.Mensageria.VerificarStatusDasOrdensRequest pRequest)
        {
            throw new NotImplementedException();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //this.RecalculaPosicaoCliente(Codigo, 7);
            Thread.Sleep(100);

            logger.Info("Recalculo de limites para compra no mercado a vista - 12 ");
            this.RecalculaPosicaoCliente(Codigo, 12);
             Thread.Sleep(100);

            logger.Info("Recalculo de limites para venda no mercado a vista - 5 ");
            this.RecalculaPosicaoCliente(Codigo, 5);
             Thread.Sleep(100);

            logger.Info("Recalculo de limites para compra no mercado de opções - 13 ");
            this.RecalculaPosicaoCliente(Codigo, 13);
             Thread.Sleep(100);

            logger.Info("Recalculo de limites para venda no mercado de opções - 7 ");
            this.RecalculaPosicaoCliente(Codigo, 7);

            MessageBox.Show("Limite recalculado");
        }
    }
}
