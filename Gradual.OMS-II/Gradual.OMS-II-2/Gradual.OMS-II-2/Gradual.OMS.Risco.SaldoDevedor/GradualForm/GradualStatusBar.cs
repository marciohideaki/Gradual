...
namespace GradualForm
{
    public class GradualStatusBar
    {
        ...
        public enum GradualStatusBarBackImageAlign
        {
            /// <summary>
            /// Left aligned image.
            /// </summary>
        ...
        private GradualStatusBarBackImageAlign m_eStatusBarImageAlign = GradualStatusBarBackImageAlign.Left;

        private Image m_BarBackground;
        private Color m_clrBarBorder = Color.FromArgb(27, 27, 27);
        private List<GradualBarItem> m_xbItems = new List<GradualBarItem>();
        private SizeGripElement sgr = new SizeGripElement();

        public List<GradualBarItem> BarItems
        {
            get
            {
        ...
        public GradualStatusBarBackImageAlign BarImageAlign
        {
            get
            {
        ...
        public class GradualBarItem
        {
            ...
            public void RenderGradualBarItem(
                Graphics g,
                int lLeft,
                int lTop
                )
           ...
           )
        {
            ...
            foreach (GradualBarItem xbi in m_xbItems)
            {

                xbi.RenderGradualBarItem(
                    g,
                    lLeft,
                    rcStatus.Top
           ...
           )
        {
            if (m_BarBackground != null)
            {
                ...
                {
                    case GradualStatusBarBackImageAlign.Right:
                        rcIcon.X = rcStatusbar.Right - lW;
                        rcIcon.Y = rcStatusbar.Bottom - lH / 2;
                        break;
                    case GradualStatusBarBackImageAlign.Center:
                        rcIcon.X = rcStatusbar.Right / 2 - lW / 2 + rcStatusbar.Height / 2;
                        rcIcon.Y = rcStatusbar.Bottom   - lH / 2;
                        break;
                    case GradualStatusBarBackImageAlign.Left:
