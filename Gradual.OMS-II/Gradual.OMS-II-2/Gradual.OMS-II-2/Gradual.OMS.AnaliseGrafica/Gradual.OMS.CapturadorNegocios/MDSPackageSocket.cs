...
namespace Gradual.OMS.CapturadorNegocios
{
    ...
    public class MDSPackageSocket
    {
        ...
        private const string RequestInstrument = "RI";
        private const string CancelInstrument = "CI";
        private const string Negocio = "NE";
        private const string SerieHistorica = "SH";
        private const string LivroOferta = "LC";
        private const string A1 = "A1";
        private const string A2 = "A2";
        private const string A3 = "A3";
        private const string A4 = "A4";
        private const string Destaques = "RP";
        private const string RankCorretora = "RC";
        ...
        public event MDSMessageReceivedHandler OnSerieHistoricaReceived;
