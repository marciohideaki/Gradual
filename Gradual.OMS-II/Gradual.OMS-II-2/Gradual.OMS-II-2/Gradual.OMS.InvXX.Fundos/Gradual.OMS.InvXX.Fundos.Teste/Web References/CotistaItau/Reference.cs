...
namespace Gradual.OMS.InvXX.Fundos.Teste.CotistaItau {
    using System;
    ...
    public partial class CotistaServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public CotistaServiceService() {
            this.Url = global::Gradual.OMS.InvXX.Fundos.Teste.Properties.Settings.Default.Gradual_OMS_InvXX_Fundos_Teste_CotistaItau_CotistaServiceService;
        ...
        public string atualizarHoldMail(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string codigoCotista, string flagHoldMail) {
        ...
        /// <remarks/>
        public void atualizarHoldMailAsync(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string codigoCotista, string flagHoldMail) {
            this.atualizarHoldMailAsync(ebusiness, senha, codigoBancoGestor, codigoBancoCliente, codigoCotista, flagHoldMail, null);
        }
        
        /// <remarks/>
        public void atualizarHoldMailAsync(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string codigoCotista, string flagHoldMail, object userState) {
            ...
            this.InvokeAsync("atualizarHoldMail", new object[] {
                        ...
                        codigoBancoCliente,
                        codigoCotista,
                        flagHoldMail}, this.atualizarHoldMailOperationCompleted, userState);
        }
        ...
        public string cadastrarCotistaPFParcial(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string cpfCnpjCotista, string nomeCotista, string dataNascimentoCotista, string situacaoTributariaCotista, string situacaoLegalCotista, string emissaoExtratoMensal, string indicadorPessoa, string contaOrdem, string codigoCidadeNaturalidade, string tipoRemessa, string cotistaVinculado) {
        ...
        /// <remarks/>
        public void cadastrarCotistaPFParcialAsync(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string cpfCnpjCotista, string nomeCotista, string dataNascimentoCotista, string situacaoTributariaCotista, string situacaoLegalCotista, string emissaoExtratoMensal, string indicadorPessoa, string contaOrdem, string codigoCidadeNaturalidade, string tipoRemessa, string cotistaVinculado) {
            this.cadastrarCotistaPFParcialAsync(ebusiness, senha, codigoBancoGestor, codigoBancoCliente, cpfCnpjCotista, nomeCotista, dataNascimentoCotista, situacaoTributariaCotista, situacaoLegalCotista, emissaoExtratoMensal, indicadorPessoa, contaOrdem, codigoCidadeNaturalidade, tipoRemessa, cotistaVinculado, null);
        }
        ...
        public void cadastrarCotistaPFParcialAsync(
            ...
            this.InvokeAsync("cadastrarCotistaPFParcial", new object[] {
                        ...
                        codigoCidadeNaturalidade,
                        tipoRemessa,
                        cotistaVinculado}, this.cadastrarCotistaPFParcialOperationCompleted, userState);
        }
        ...
        public void cadastrarCotistaPFCompletoAsync(
                    ...
                    string dataFimResidente, 
                    string cotistaVinculado) {
            this.cadastrarCotistaPFCompletoAsync(ebusiness, senha, codigoBancoGestor, codigoBancoCliente, cpfCnpjCotista, nomeCotista, dataNascimentoCotista, situacaoTributariaCotista, situacaoLegalCotista, emissaoExtratoMensal, indicadorPessoa, contaOrdem, codigoCidadeNaturalidade, tipoRemessa, tipoDocumentoCotista, numeroDocumentoCotista, dataExpedicaoDocumentoCotista, orgaoExpeditorDocumento, estadoEmissorDocumentoCotista, sexo, codigoEstadoCivilCotista, profissao, email, assessor, codigoGestorCliente, emissaoExtratoMovimentacoes, tipoPessoaCotista, valorRendaFamiliar, valorPatrimonio, codigoDistribuidor, nomePai, nomeMae, avisoMovimentacoes, renovacaoCadastral, codigoNacionalidade, paisResidencia, resolucao2689, nomeConjuge, numeroDDD1, telefone1, ramal1, numeroDDD2, telefone2, ramal2, numeroDDD3, telefone3, ramal3, numeroIdentificacaoFiscal, dataComunicadoFormalizacaoSaida, dataInicioResidente, dataFimResidente, cotistaVinculado, null);
        }
        ...
        public void cadastrarCotistaPFCompletoAsync(
            ...
            this.InvokeAsync("cadastrarCotistaPFCompleto", new object[] {
                        ...
                        dataInicioResidente,
                        dataFimResidente,
                        cotistaVinculado}, this.cadastrarCotistaPFCompletoOperationCompleted, userState);
        }
        ...
        public string cadastrarCotistaPJParcial(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string cpfCnpjCotista, string nomeCotista, string situacaoTributariaCotista, string emissaoExtratoMensal, string indicadorPessoa, string contaOrdem, string codigoLocalidade, string tipoRemessa, string cotistaVinculado) {
        ...
        public void cadastrarCotistaPJParcialAsync(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string cpfCnpjCotista, string nomeCotista, string situacaoTributariaCotista, string emissaoExtratoMensal, string indicadorPessoa, string contaOrdem, string codigoLocalidade, string tipoRemessa, string cotistaVinculado) {
            this.cadastrarCotistaPJParcialAsync(ebusiness, senha, codigoBancoGestor, codigoBancoCliente, cpfCnpjCotista, nomeCotista, situacaoTributariaCotista, emissaoExtratoMensal, indicadorPessoa, contaOrdem, codigoLocalidade, tipoRemessa, cotistaVinculado, null);
        }
        
        /// <remarks/>
        public void cadastrarCotistaPJParcialAsync(string ebusiness, string senha, string codigoBancoGestor, string codigoBancoCliente, string cpfCnpjCotista, string nomeCotista, string situacaoTributariaCotista, string emissaoExtratoMensal, string indicadorPessoa, string contaOrdem, string codigoLocalidade, string tipoRemessa, string cotistaVinculado, object userState) {
            ...
            this.InvokeAsync("cadastrarCotistaPJParcial", new object[] {
                        ...
                        codigoLocalidade,
                        tipoRemessa,
                        cotistaVinculado}, this.cadastrarCotistaPJParcialOperationCompleted, userState);
        }
        ...
        public void cadastrarCotistaPJCompletoAsync(
            ...
            this.InvokeAsync("cadastrarCotistaPJCompleto", new object[] {
                        ...
                        dataInicioResidente,
                        dataFimResidente,
                        cotistaVinculado}, this.cadastrarCotistaPJCompletoOperationCompleted, userState);
        }
        ...
        public void alterarCotistaPFAsync(
            ...
            this.InvokeAsync("alterarCotistaPF", new object[] {
                        ...
                        dataInicioResidente,
                        dataFimResidente,
                        cotistaVinculado}, this.alterarCotistaPFOperationCompleted, userState);
        }
        ...
        public void alterarCotistaPJAsync(
            ...
            this.InvokeAsync("alterarCotistaPJ", new object[] {
                        ...
                        dataInicioResidente,
                        dataFimResidente,
                        cotistaVinculado}, this.alterarCotistaPJOperationCompleted, userState);
        }
