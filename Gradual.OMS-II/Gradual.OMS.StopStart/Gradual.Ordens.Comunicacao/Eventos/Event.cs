...
namespace Gradual.OMS.Comunicacao.Automacao.Ordens.Eventos
{
    ...
    {
        public delegate void MDSAuthenticationResponseEventHandler(object Response, Socket _ClientSocket);
        public static event MDSAuthenticationResponseEventHandler _MDSAuthenticationResponse;
