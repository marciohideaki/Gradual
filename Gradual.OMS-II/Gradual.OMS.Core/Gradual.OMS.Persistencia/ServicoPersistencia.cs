	...
	public class ServicoPersistencia : IServicoPersistencia
    {
        ...
        public ServicoPersistencia()
        {
            ...
            if (_config != null)
            {
                ...
                logger.Error("ServicoPersistencia.Constructor(): CONFIGURACOES NAO CARREGADAS!!!!");
        }
        ...
        public void AdicionarPersistencia(PersistenciaInfo persistenciaInfo)
        {
            ...
            if (persistenciaInfo.TipoPersistencia == null)
            {
                logger.Error("TipoPersistencia nao definido para " + persistenciaInfo.TipoPersistenciaString + ". Verifique se assembly existe no diretorio da aplicacao");
                return;
            }
