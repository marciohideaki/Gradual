...
using Gradual.OMS.Alavancagem.ReCalculoAutomatico;
...
namespace ConsoleAlavancagemOperacional
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            gTimerRecalculaPosicao = new System.Threading.Timer(new TimerCallback(RecalcularClientePosicaoIntradiaria), null, 0, (5 * 1000));
        }
        ...
        private void RecalcularClientePosicaoIntradiaria(object state)
        {
            ...
            TimeSpan DataFinal = new TimeSpan();
            ...
            finally
            {
                ...
                string Teste = DataFinal.ToString();
            }
