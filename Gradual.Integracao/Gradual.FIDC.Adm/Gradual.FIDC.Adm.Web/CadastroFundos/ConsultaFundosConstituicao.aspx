<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ConsultaFundosConstituicao.aspx.cs" Inherits="Gradual.FIDC.Adm.Web.CadastroFundos.ConsultaFundosConstituicao" validateRequest="false"  %>
<asp:Content ID="Content1" contentplaceholderid="ContentPlaceHolder1" runat="server">
    <div class="innerLR">
        <div class="formulario box-generic">            
            <div id="ConsultaFundosConstituicao_pnlFiltroPesquisa">
                ...
                <div class="container-fluid">
                    ...
                    <!--Primeira linha -->
                        <div class="row">
                            ...
                            <h4>Fundos em Constituição</h4></div>
                            <div class="col-md-5 col-xs-5" style="padding-left: 25px">
                                <select id="listaFundosConstituicao" class="form-control">
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input type="button" id="btnBuscarDados" value="Consultar" onclick="return fnBuscarDadosConsultaFundosConstituicao();" class="btn btn-info btn-block" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-5 col-xs-5">
                            ...
                            <div class="col-md-2 col-xs-2">
                                <input type="button" id="btnLimparFiltros" value="Limpar Filtros" onclick="return fnLimparFiltrosConsultaFundosConstituicao();" class="btn btn-warning btn-block" />
                            </div>                     
                        </div>
                    </div>
                </div>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer" style="text-align: center">
                    <button type="button" class="btn btn-primary" onclick="fnEnviarEmailConsultaFundosConstituicao()">Enviar</button>
                  </div>
                </div>
