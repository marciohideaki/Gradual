function ExportJQGridDataToExcel(tableCtrl, excelFilename) {
    ...
    //var allJQGridData = $(tableCtrl).jqGrid('getGridParam', 'data'); dados sem o filtro
    var allJQGridData = $(tableCtrl).jqGrid('getRowData');//dados filtrados
    ...
    postAndRedirect("/Handlers/DownloadHandler.ashx?filename=" + excelFilename, { excelData: excelData });
}
