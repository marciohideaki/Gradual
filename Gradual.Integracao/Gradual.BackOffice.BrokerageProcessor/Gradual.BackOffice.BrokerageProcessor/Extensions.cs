...
namespace Gradual.BackOffice.BrokerageProcessor
{
    public static class Extensions
    {
        ...
        public static DateTime ByteArrayToDate(this byte[] datearr, string parseformat)
        {
            ...
            tempString.Append(Encoding.UTF8.GetString(buf, 0, datearr.Length).PadRight(parseformat.Length, '0'));
            //tempString.Append("000000");

            DateTime ret = DateTime.MinValue;

            if (!DateTime.TryParseExact(tempString.ToString(), parseformat, CultureInfo.InvariantCulture, DateTimeStyles.None, out ret))
            {
        ...
        /// <summary>
        /// Preenche um byte array com o valor fornecido
        /// </summary>
        /// <param name="filler">Valor a ser usado para preenchimento</param>
        /// <returns></returns>
        public static void FillWithByte(this byte[] barray, byte filler)
        {
