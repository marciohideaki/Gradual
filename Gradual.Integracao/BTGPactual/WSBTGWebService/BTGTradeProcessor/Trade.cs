...
namespace BTGTradeProcessor
{
    ...
    public class Trade
    {
        ...
        /// 
        /// </summary>
        public string TipoBoletagem { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public long ChaveEstrangeira { get; set; }
        ...
        public string TaxaJurosLongo { get; set; }


        public string TaxaJurosCurto { get; set; }
        ...
        public string ToXML()
        {
            ...
            xml += "<TIPO_BOLETAGEM>" + this.TipoBoletagem + "</TIPO_BOLETAGEM>";
            ...
            xml += "<DATA_TERMO>" + this.DataTermo.ToString("yyyy-MM-dd") + "</DATA_TERMO>";
            ...
            xml += "<TX_JUROS_LONGO>" + this.TaxaJurosLongo + "</TX_JUROS_LONGO>";
            xml += "<TX_JUROS_CURTO>" +  this.TaxaJurosCurto + "</TX_JUROS_CURTO>";
