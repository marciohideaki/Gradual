...
namespace Gradual.Spider.GlobalOrderTracking
{
    public static class Extensions
    {
        ...
        public static string ToNumeroAbreviado(this double pObject)
        {
            ...
            return lNumero.ToString(new System.Globalization.CultureInfo("pt-BR")) + lFormato;
        }
        ...
        public static Int32 SubtractFromInt(this object pObject, Int32 pNumber)
        {
            if (pObject == null || pObject == DBNull.Value) return 0;

            Int32 lReturn = 0;
            if (pObject.GetType() == typeof(byte))
            {
                lReturn = Convert.ToInt32(pObject) - pNumber;
                if (lReturn > 0)
                {
                    return lReturn;
                }
