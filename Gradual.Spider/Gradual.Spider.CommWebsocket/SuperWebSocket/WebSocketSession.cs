...
namespace SuperWebSocket
{
    ...
    {
        /// <summary>
        /// Lista de Papeis...temporária
        /// </summary>
        public List<int> ListClientSubscriptions = new List<int>();

        /// <summary>
        /// Request de filtro de Operações Intraday
        /// </summary>
        public BuscarOperacoesIntradaySocketRequest lOperacoesIntradayRequest = null;

        /// <summary>
        /// Request de filtro de Risco resumido 
        /// </summary>
        public BuscarRiscoResumidoSocketRequest lRiscoResumidoRequest = null;
