    ...
    namespace FIX44 
    {
        public class Quote : Message
        {
            ...
            public Quote(
                    ...
                    QuickFix.Fields.SettlType aSettlType,
                    QuickFix.Fields.DaysToSettlement aDaysToSettlement,
                    QuickFix.Fields.FixedRate aFixedRate,
                ...
                ) : this()
            {
                ...
                this.SettlType = aSettlType;
                this.DaysToSettlement = aDaysToSettlement;
                this.FixedRate = aFixedRate;
