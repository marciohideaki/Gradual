...
namespace QuickFix
{
    namespace FIX44 
    {
        public class SequenceReset : Message
        {
            ...
            public QuickFix.Fields.PossMissingApplMsg PossMissingApplMsg
            { 
                get 
                {
                    QuickFix.Fields.PossMissingApplMsg val = new QuickFix.Fields.PossMissingApplMsg();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PossMissingApplMsg val) 
            { 
                this.PossMissingApplMsg = val;
            }
            
            public QuickFix.Fields.PossMissingApplMsg Get(QuickFix.Fields.PossMissingApplMsg val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.PossMissingApplMsg val) 
            { 
                return IsSetPossMissingApplMsg();
            }
            
            public bool IsSetPossMissingApplMsg() 
            { 
                return IsSetField(Tags.PossMissingApplMsg);
            }
