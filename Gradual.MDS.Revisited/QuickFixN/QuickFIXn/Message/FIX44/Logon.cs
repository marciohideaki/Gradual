...
namespace QuickFix
{
    namespace FIX44 
    {
        public class Logon : Message
        {
            ...
            public QuickFix.Fields.BTSRequesterIPAddress BTSRequesterIPAddress
            { 
                get 
                {
                    QuickFix.Fields.BTSRequesterIPAddress val = new QuickFix.Fields.BTSRequesterIPAddress();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BTSRequesterIPAddress val) 
            { 
                this.BTSRequesterIPAddress = val;
            }
            
            public QuickFix.Fields.BTSRequesterIPAddress Get(QuickFix.Fields.BTSRequesterIPAddress val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BTSRequesterIPAddress val) 
            { 
                return IsSetBTSRequesterIPAddress();
            }
            
            public bool IsSetBTSRequesterIPAddress() 
            { 
                return IsSetField(Tags.BTSRequesterIPAddress);
            }
            public QuickFix.Fields.BTSRequesterOSIdentifier BTSRequesterOSIdentifier
            { 
                get 
                {
                    QuickFix.Fields.BTSRequesterOSIdentifier val = new QuickFix.Fields.BTSRequesterOSIdentifier();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BTSRequesterOSIdentifier val) 
            { 
                this.BTSRequesterOSIdentifier = val;
            }
            
            public QuickFix.Fields.BTSRequesterOSIdentifier Get(QuickFix.Fields.BTSRequesterOSIdentifier val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BTSRequesterOSIdentifier val) 
            { 
                return IsSetBTSRequesterOSIdentifier();
            }
            
            public bool IsSetBTSRequesterOSIdentifier() 
            { 
                return IsSetField(Tags.BTSRequesterOSIdentifier);
            }
            public QuickFix.Fields.ApplicationLogonRspCode ApplicationLogonRspCode
            { 
                get 
                {
                    QuickFix.Fields.ApplicationLogonRspCode val = new QuickFix.Fields.ApplicationLogonRspCode();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.ApplicationLogonRspCode val) 
            { 
                this.ApplicationLogonRspCode = val;
            }
            
            public QuickFix.Fields.ApplicationLogonRspCode Get(QuickFix.Fields.ApplicationLogonRspCode val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.ApplicationLogonRspCode val) 
            { 
                return IsSetApplicationLogonRspCode();
            }
            
            public bool IsSetApplicationLogonRspCode() 
            { 
                return IsSetField(Tags.ApplicationLogonRspCode);
            }
            public QuickFix.Fields.DaysBeforePwdExpiration DaysBeforePwdExpiration
            { 
                get 
                {
                    QuickFix.Fields.DaysBeforePwdExpiration val = new QuickFix.Fields.DaysBeforePwdExpiration();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.DaysBeforePwdExpiration val) 
            { 
                this.DaysBeforePwdExpiration = val;
            }
            
            public QuickFix.Fields.DaysBeforePwdExpiration Get(QuickFix.Fields.DaysBeforePwdExpiration val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.DaysBeforePwdExpiration val) 
            { 
                return IsSetDaysBeforePwdExpiration();
            }
            
            public bool IsSetDaysBeforePwdExpiration() 
            { 
                return IsSetField(Tags.DaysBeforePwdExpiration);
            }
            ...
            public QuickFix.Fields.CancelOnDisconnectType CancelOnDisconnectType
            { 
                get 
                {
                    QuickFix.Fields.CancelOnDisconnectType val = new QuickFix.Fields.CancelOnDisconnectType();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CancelOnDisconnectType val) 
            { 
                this.CancelOnDisconnectType = val;
            }
            
            public QuickFix.Fields.CancelOnDisconnectType Get(QuickFix.Fields.CancelOnDisconnectType val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CancelOnDisconnectType val) 
            { 
                return IsSetCancelOnDisconnectType();
            }
            
            public bool IsSetCancelOnDisconnectType() 
            { 
                return IsSetField(Tags.CancelOnDisconnectType);
            }
            public QuickFix.Fields.CODTimeoutWindow CODTimeoutWindow
            { 
                get 
                {
                    QuickFix.Fields.CODTimeoutWindow val = new QuickFix.Fields.CODTimeoutWindow();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.CODTimeoutWindow val) 
            { 
                this.CODTimeoutWindow = val;
            }
            
            public QuickFix.Fields.CODTimeoutWindow Get(QuickFix.Fields.CODTimeoutWindow val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.CODTimeoutWindow val) 
            { 
                return IsSetCODTimeoutWindow();
            }
            
            public bool IsSetCODTimeoutWindow() 
            { 
                return IsSetField(Tags.CODTimeoutWindow);
            }
