...
namespace QuickFix
{
    namespace FIX44 
    {
        public class AllocationReport : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.TradeID, Tags.CoveredOrUncovered, Tags.SecurityStrategyType, Tags.LastQty, Tags.ExecID, Tags.SecondaryExecID, Tags.LastPx, Tags.LastParPx, Tags.LastCapacity, 0};
            
                public NoExecsGroup() 
                  :base( Tags.NoExecs, Tags.TradeID, fieldOrder)
                {
                }
