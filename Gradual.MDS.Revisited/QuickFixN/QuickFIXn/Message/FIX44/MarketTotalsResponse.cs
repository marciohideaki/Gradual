...
namespace QuickFix
{
    namespace FIX44 
    {
        public class MarketTotalsResponse : Message
        {
            public const string MsgType = "UTOTP";

            public MarketTotalsResponse() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("UTOTP"));
            }
