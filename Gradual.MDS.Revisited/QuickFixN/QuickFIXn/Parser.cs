namespace QuickFix
{
    ...
    public class Parser
    {
        ...
        {
            byte[] bytes = Values.ENCODING.GetBytes(data);
        ...
        {
            return ExtractLength(out length, out pos, Values.ENCODING.GetBytes(buf));
        }
        ...
        {
            byte[] patternToFind = Values.ENCODING.GetBytes(stringPatternToFind);
        ...
        private string Substring(byte[] array, int startIndex, int length)
        {
            ...
            //return System.Text.Encoding.GetEncoding(1252).GetString(returnByte);
            return Values.ENCODING.GetString(returnByte);
        }
    }
}
