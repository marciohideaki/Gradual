            ...
            <div id="pnlDadosDeCompra_RealizarCompra" runat="server" visible="false">
                ...
                <fieldset class="FormularioPadrao">
                    ...
                    <p class="BotoesDeReserva" style="text-align:center">
                        <button id="btnPedidoReservaNormal" runat="server" class="botao btn-padrao" style="width:40%" visible="false" onclick="return btnPedidoDeReservaIPO_Click(this)">Realizar Pedido de Reserva</button>
                        <button id="btnPedidoPrioritarioPN" runat="server" class="botao btn-padrao" style="width:40%" visible="false" onclick="return btnPedidoDeReservaIPO_Click(this)">Realizar Pedido de Reserva Prioritário - Ações Prioritárias</button>
                        <button id="btnPedidoVarejoPN"      runat="server" class="botao btn-padrao" style="width:40%" visible="false" onclick="return btnPedidoDeReservaIPO_Click(this)">Realizar Pedido de Reserva de Varejo - Ações Prioritárias</button>
                        <button id="btnPedidoPrioritarioON" runat="server" class="botao btn-padrao" style="width:40%" visible="false" onclick="return btnPedidoDeReservaIPO_Click(this)">Realizar Pedido de Reserva Prioritário - Ações Ordinárias</button>
                        <button id="btnPedidoVarejoON"      runat="server" class="botao btn-padrao" style="width:40%" visible="false" onclick="return btnPedidoDeReservaIPO_Click(this)">Realizar Pedido de Reserva de Varejo - Ações Ordinárias</button>
                    </p>
