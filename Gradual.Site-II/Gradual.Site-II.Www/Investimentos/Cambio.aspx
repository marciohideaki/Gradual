...
<section id="pnlConteudoNormal" runat="server" class="PaginaConteudo">
    ...
    <div class="row" style="margin-bottom: 24px">
        ...
        <div class="col1">
            <p>
            “Informamos que não haverá movimento de câmbio entre os dias 28/12/2017 e 01/01/2018, por isso não efetuaremos compra e venda de moedas estrangeiras, retornando ao normal dia 02/01/2018.” 
            </p>
            <p>
Desejamos a todos nossos clientes e parceiros um Próspero Ano Novo.
            </p>
            <p>
Atenciosamente,<br />
Equipe Gradual Câmbio
            </p>
        </div>
    </div>

    <ul class="abas-menu abas-simples"  style="display:none;">
        ...
        <!--        
        <li data-tipolink="Embutida" data-idconteudo="desc-lojas">
            <a href="#" id="A1">Lojas</a> 
        </li>
        -->
    </ul>

    <div data-idconteudo="desc-turismo" class="row" style="display:none;">
    ...
    <!-- Removido conforme solicitação do depto. de câmbio em 2017.07.19 -->
    <div data-idconteudo="desc-lojas" class="row" style="display:none">
        <div class="lojas">
        <asp:repeater id="rptLojas" runat="server">
        <itemtemplate>       
            <p>
                <em style="font-weight:bold;color:#222">
                Nome Fantasia      : <%# Eval("NomeFantasia") %></em>
                <br/>Nome Empresarial   : <%# Eval("RazaoSocial") %>
                <br/>CNPJ               : <%# String.Format(@"{0:00\.000\.000\/0000\-00}", Eval("CNPJ")) %>
                <br/>Endereço           : <%# Eval("Endereco") %>
                <br/>Fones para contato : <%# Eval("Telefone") %>
                <br/>Horário de atendimento: segunda a sexta-feira das 09:00h às 18:00h.
                <br/>Produtos ofertados : compra e venda de moedas, remessas internacionais e cartões de viagens.
            </p>
        </itemtemplate>
        </asp:repeater>
