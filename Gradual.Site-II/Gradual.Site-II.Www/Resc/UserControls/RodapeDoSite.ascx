        ...
        <div class="inner">
            <div class="borda-footer clear">
                <ul id="mapa-site">
                    ...
                    <li><a href="<%= this.HostERaiz %>/CanalDenuncias/Default.html">Canal de Denúncias</a></li>
            ...
            <ul class="lista-bolsa">
                ...
                <li><a target="_blank" href="http://www.bsm-autorregulacao.com.br/">BSM</a></li>
            ...
            <ul class="imagens-footer clear">
                ...
                <li> <a href="http://portal.anbima.com.br/Pages/home.aspx" target="_blank"><img src="<%= this.HostERaiz %>/Resc/Skin/Default/Img/f12.png" /></a> </li>
                <li> <a href="http://portal.anbima.com.br/Pages/home.aspx" target="_blank"><img src="<%= this.HostERaiz %>/Resc/Skin/Default/Img/selo_ambima_portal1.png" /></a> </li>
                <li> <a href="http://portal.anbima.com.br/Pages/home.aspx" target="_blank"><img src="<%= this.HostERaiz %>/Resc/Skin/Default/Img/selo_ambima_portal2.png" /></a> </li>
