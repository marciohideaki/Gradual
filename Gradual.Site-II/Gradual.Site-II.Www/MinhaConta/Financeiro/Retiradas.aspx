            ...
            <div class="col3">
                <div class="form-padrao">
                    <div class="campo-basico campo-senha">
                        ...
                        <asp:textbox id="txtAssDigital" runat="server" type="password" class="senha mostrar-teclado" onclick="javascript:return showKeyboard($('#btnRetirada_Assinatura'), event, { Controle: '#ContentPlaceHolder1_txtAssDigital', Mensagem: 'Assinatura' } );"></asp:textbox>

                        <%--<button class="teclado-virtual" type="button"><img alt="Teclado Virtual" src="../../Resc/Skin/Default/Img/teclado.png"></button>--%>
                        <button class="teclado-virtual" type="button" id="btnRetirada_Assinatura" onclick="javascript:return showKeyboard(this, event, { Controle: '#ContentPlaceHolder1_txtAssDigital', Mensagem: 'Assinatura' });"><img src="../../Resc/Skin/Default/Img/teclado.png" alt="Teclado Virtual" /></button>
                    </div>
