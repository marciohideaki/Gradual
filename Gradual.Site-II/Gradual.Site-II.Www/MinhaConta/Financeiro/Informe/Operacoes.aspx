<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaInterna.Master" AutoEventWireup="true" CodeBehind="Operacoes.aspx.cs" Inherits="Gradual.Site.Www.MinhaConta.Financeiro.Informe.Operacoes" %>
        ...
        <div class="col1">
            <div id="abas-generico" class="abas-counte">
                ...
                <div id="abas-conteudo" class="abas-conteudo">
                    <div class="aba">
                        <p>Para consultar seu extrato de Operações, é preciso definir o período de tempo desejado.</p>
                        ...
                        <div class="form-padrao">
                            ...
                            <div class="row">
                                <div class="col3">
                                    <asp:button CssClass="botao btn-padrao btn-erica" Text="Consultar" 
                                        runat="server" Click="btnOperacoes_Click" ID="btnOperacoes" 
                                        onclick="btnOperacoes_Click" style="margin-bottom:20px" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<ucSauron:Sauron id="Sauron1" runat="server" nomedapagina="Financeiro - Informe Operações" />
