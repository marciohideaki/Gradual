<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaInterna.Master" AutoEventWireup="true" CodeBehind="DayTrade.aspx.cs" Inherits="Gradual.Site.Www.MinhaConta.Financeiro.Informe.DayTrade" %>
        ...
        <div class="col1">
            <div id="abas-generico" class="abas-counte">
                ...
                <div id="abas-conteudo" class="abas-conteudo">
                    <div class="aba" class="ativo">
                        <p>Para consultar seu extrato de Day Trade, é preciso definir o período de tempo desejado</p>
                            ...
                            <div class="row">
                                <div class="col3">
                                    <asp:button CssClass="botao btn-padrao btn-erica" Text="Consultar" 
                                        runat="server"  ID="btnDayTrade" 
                                        onclick="btnDayTrade_Click" style="margin-bottom:20px" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<ucSauron:Sauron id="Sauron1" runat="server" nomedapagina="Financeiro - Day Trade" />
