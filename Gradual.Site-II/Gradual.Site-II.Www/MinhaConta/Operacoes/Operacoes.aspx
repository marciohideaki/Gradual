                ...
                <div class="col1">
                    <div class="form-padrao-envioordens">
                        <div class="campo-basico campo-senha">
                            ...
                            <input type="password" value="" id="txtOrdem_Assinatura" class="txtOrdem_Assinatura mostrar-teclado" name="input-padrao" tabindex="7" onclick="javascript:return showKeyboard($('#btnSeguranca_Assinatura'), event, { Controle: '#txtOrdem_Assinatura', Mensagem: 'Assinatura Eletrônica' } );"/>
                            ...
                            <button class="teclado-virtual" type="button" id="btnSeguranca_Assinatura" onclick="javascript:return showKeyboard(this, event, { Controle: '#txtOrdem_Assinatura', Mensagem: 'Assinatura Eletrônica' });"><img src="../../../Resc/Skin/Default/Img/teclado.png" alt="Teclado Virtual" /></button>
                        </div>
