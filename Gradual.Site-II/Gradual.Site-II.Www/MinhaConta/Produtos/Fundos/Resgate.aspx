                    ...
                    <div class="col2" style="width:312px; margin-top:20px">
                        <div class="form-padrao">
                            <div class="campo-basico campo-senha">
                                ...
                                <asp:textbox id="txtAssDigital" runat="server" type="password" class="mostrar-teclado" onclick="javascript:return showKeyboard($('#btnResgate_Assinatura'), event, { Controle: '#ContentPlaceHolder1_txtAssDigital', Mensagem: 'Assinatura Eletrônica' } );"></asp:textbox>
                                <%--<button class="teclado-virtual" type="button"><img alt="Teclado Virtual" src="../../../Resc/Skin/Default/Img/teclado.png"></button>--%>
                                <button class="teclado-virtual" type="button" id="btnResgate_Assinatura" onclick="javascript:return showKeyboard(this, event, { Controle: '#ContentPlaceHolder1_txtAssDigital', Mensagem: 'Assinatura Eletrônica' });"><img src="../../../Resc/Skin/Default/Img/teclado.png" alt="Teclado Virtual" /></button>
                            </div>
