<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acoes.aspx.cs" Inherits="Gradual.Site.Www.MinhaConta.Produtos.Fundos.Acoes" MasterPageFile="~/PaginaInterna.Master" %>
...
<div class="row">
    <div class="col1">
        ...
        <p>Confira a relação dos Fundos de Ações disponíveis para você investir.</p>
...
<ucSauron:Sauron id="Sauron1" runat="server" nomedapagina="Prod - Fds - Ações" />
