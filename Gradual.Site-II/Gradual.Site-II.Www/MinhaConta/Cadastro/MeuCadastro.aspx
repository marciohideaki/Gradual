                ...
                <div class="row">
                    <div class="col1">
                        ...
                        <div class="abas-conteudo" style="padding-bottom: 2em">
                            ...
                            <!---End-content-FormPadrao---->
                        </div>
                            <!---End-content-DadosBasicos---->

                            <!---Start-content-DadosPessoais---->
...
<%  if (!this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(3)) { %>                        
                            <!---Start-content-DadosFinanceiros---->
...
%>
                                    ...
                                    <!---End-content-ContaBancaria---->
                                        ...
                                        <div class="row">
                                            <div class="col1">
                                                ...
                                                <div class="lista-radio">
                                                    <label class="radio"><input  id="rdoSuit_02_A" type="radio" value="0" name="rdoSuit_02" /> Nunca investe, e se o fizesse seria na poupança</label>
                                                    <label class="radio"><input  id="rdoSuit_02_B" type="radio" value="1" name="rdoSuit_02" /> Investe periodicamente 10% de sua renda, mas só em produtos de renda fixa</label>
                                                    <label class="radio"><input  id="rdoSuit_02_C" type="radio" value="2" name="rdoSuit_02" /> Investe todo mês até 20% de sua renda em uma cesta de produtos diversos</label>
                                                    <label class="radio"><input  id="rdoSuit_02_D" type="radio" value="3" name="rdoSuit_02" /> Investe toda semana, sobretudo, na compra e venda de ações</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col1">
                                                ...
                                                <div class="lista-radio">
                                                    <label class="radio"><input  id="rdoSuit_03_A" type="radio" value="0" name="rdoSuit_03" /> Nenhum</label>
                                                    <label class="radio"><input  id="rdoSuit_03_B" type="radio" value="1" name="rdoSuit_03" /> Pouco, conheço apenas Poupança, Tesouro Direto e alguns produtos de renda fixa</label>
                                                    <label class="radio"><input  id="rdoSuit_03_C" type="radio" value="2" name="rdoSuit_03" /> Bom, já investi em vários produtos de renda fixa, e comprei ações algumas vezes</label>
                                                    <label class="radio"><input  id="rdoSuit_03_D" type="radio" value="3" name="rdoSuit_03" /> Ótimo, invisto em renda fixa e renda variável, e já realizei operações com derivativos</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col1">
                                                ...
                                                <div class="lista-radio">
                                                    <label class="radio"><input  id="rdoSuit_04_A" type="radio" value="0" name="rdoSuit_04" /> Proteger seu dinheiro da inflação</label>
                                                    <label class="radio"><input  id="rdoSuit_04_B" type="radio" value="1" name="rdoSuit_04" /> Ganhar da Poupança</label>
                                                    <label class="radio"><input  id="rdoSuit_04_C" type="radio" value="2" name="rdoSuit_04" /> Ganhar dos produtos dos bancos (CDB, Capitalização)</label>
                                                    <label class="radio"><input  id="rdoSuit_04_D" type="radio" value="3" name="rdoSuit_04" /> Investir com isenção de imposto de renda</label>
                                                    <label class="radio"><input  id="rdoSuit_04_E" type="radio" value="4" name="rdoSuit_04" /> Buscar bons e rápidos rendimentos</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col1">
                                                ...
                                                <div class="lista-radio">
                                                    ...
                                                    <label class="radio" style="display:block;"><input  id="rdoSuit_05_E" type="radio" value="4" name="rdoSuit_05" /> Derivativos</label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <!---End-content-DadosFinanceiros---->
                        
<% } else { %>
                            <!---Start-content-DadosFinanceirosCambio---->
                            <div id="pnlDadosFinanceirosCambio" data-IdConteudo="DadosFinanceiros" runat="server" class="aba" style="display:none">
                            <div class="menu-exportar clear">
                                <h3>Dados Financeiros 
<%
                            if (this.ModoDeTeste) 
                            { 
%>
                                    <a href="#" onclick="return Cadastro_PreencherTesteCambio_P3()" style="font-size:0.4em; font-weight:normal; color:Blue">preencher</a>
                                    <a href="#" onclick="return Cadastro_PreencherTesteCambio_P3(true)" style="font-size:0.4em; font-weight:normal; color:Blue; margin-left:2em">completo</a>
<% 
                            } 
%>
                                </h3>
                            ...
                            <div class="form-padrao">
                                ...
                                <!---Start-content-ContaBancaria---->
                                <div id="pnlFormNovaContaBancaria_Cambio" runat="server">

                                    <div class="row">
                                        <div class="col2">
                                            <div class="campo-basico">
                                                <label>Tipo de Conta:</label>
                                                <asp:dropdownlist id="cboCadastro_PFPasso3_ContasBancarias_TipoContaCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" cssclass="EstiloCampoObrigatorio">
                                                </asp:dropdownlist>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col2">
                                            <div class="campo-basico">
                                                <label>Banco:</label>
                                                    <asp:dropdownlist id="cboCadastro_PFPasso3_ContasBancarias_BancoCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" onchange="return cboCadastro_PFPasso3_ContasBancarias_Banco_OnChange(this);" cssclass="EstiloCampoObrigatorio">
                                                    </asp:dropdownlist>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col2">
                                            <div class="campo-basico">
                                                <label>Agência e Dígito:</label>
                                                <div class="clear">
                                                    <input  id="txtCadastro_PFPasso3_ContasBancarias_AgenciaCambio" type="text" maxlength="5" class="EstiloCampoObrigatorio ProibirLetras input-telefone" style="float:left;" />
                                                    <input  id="txtCadastro_PFPasso3_ContasBancarias_AgenciaDigitoCambio" type="text" maxlength="2" class="EstiloCampoObrigatorio ProibirLetrasMenosX input-ddd" style="float:right; position:absolute; right:0;" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col2">
                                            <div class="campo-basico">
                                                <label>Conta e Dígito:</label>
                                                <div class="clear">
                                                    <input  id="txtCadastro_PFPasso3_ContasBancarias_ContaCambio" type="text" maxlength="13" class="EstiloCampoObrigatorio ProibirLetras input-telefone" style="float:left;" />
                                                    <input  id="txtCadastro_PFPasso3_ContasBancarias_ContaDigitoCambio" type="text" maxlength="2" class="EstiloCampoObrigatorio ProibirLetras input-ddd" style="float:right; position:absolute; right:0;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col3-2">
                                            ...
                                            <div class="lista-radio">
                                                <label class="radio">
                                                    <input  id="rdoCadastro_PFPasso3_ContasBancarias_ContaTitular_SimCambio" name="rdoCadastro_PFPasso3_ContasBancarias_ContaTitular" type="radio" onclick="return rdoCadastro_PFPasso3_ContasBancariasCambio_Click(this)" checked="checked" />
                                                    Sim
                                                </label>
                                                <label class="radio">
                                                    <input  id="rdoCadastro_PFPasso3_ContasBancarias_ContaTitular_NaoCambio" name="rdoCadastro_PFPasso3_ContasBancarias_ContaTitular" type="radio" onclick="return rdoCadastro_PFPasso3_ContasBancariasCambio_Click(this)" />
                                                        Não
                                                </label>
                                            </div>
                                        </div>

                                        <div id="pnlTitularContaCambio" style="display:none; float:left; width:100%">
                                            <p style="width:55%;">
                                                <label for="txtCadastro_PFPasso3_ContasBancarias_NomeTitularCambio">Nome do Titular:</label>
                                                <input  id="txtCadastro_PFPasso3_ContasBancarias_NomeTitularCambio" type="text" data-CaixaAlta="true" maxlength="120" class="EstiloCampoObrigatorio" />
                                            </p>

                                            <p style="width:20%;">
                                                <label for="txtCadastro_PFPasso3_ContasBancarias_CPFTitularCambio">CPF do Titular:</label>
                                                <input  id="txtCadastro_PFPasso3_ContasBancarias_CPFTitularCambio" type="text" data-CaixaAlta="true"  maxlength="10" class="EstiloCampoObrigatorio Mascara_CPF ProibirLetras " />
                                            </p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col1">
                                            <button class="botao btn-padrao btn-erica" onclick="return btnCadastro_PFPasso3_AdicionarContaBancariaCambio_Click(this)" type="button">Adicionar</button>
                                        </div>
                                    </div>
                                ...
                                <!---End-content-ContaBancaria---->
                                        ...
                                        <input type="hidden" id="hidCadastro_PFPasso3_ContasBancariasCambio" runat="server" />

                                        <table id="tblCadastro_PFPasso3_ContaBancariaCambio" class="tabela TabelaDeContas">
                                        <thead>
                                            <tr class="tabela-titulo tabela-type-small">
                                                <td style="width:16%">Banco</td>
                                                <td style="width:10%">Cód. Banco</td>
                                        ...
                                        <tbody>
                                            <tr id="tr1" runat="server" class="NenhumItem">
                                                <td colspan="9">(nenhuma conta incluída)</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="ContaDigito">    <%#Eval("ContaDigito") %>    </td>
                                                <td>
                                                    <button onclick="return btnCadastro_PFPasso3_ExcluirContaBancariaCambio_Click(this);" class="BotaoIcone IconeRemoverMarrom"><span>Excluir</span></button>
                                                </td>
                                            </tr>
                                            </itemtemplate>
                                            </asp:repeater>
                                ...
                                <!---Start-content-Rendimentos---->
                                <div class="row">
                                    <div class="row">
                                    <div class="col1">
                                        <div class="campo-basico">
                                            <label>Renda Mensal:</label>
                                            <input id="txtCadastro_PFPasso3_OutrosRendimentosCambio" runat="server" type="text" maxlength="14" placeholder="R$ 0,00" class="EstiloCampoObrigatorio ValorMonetario validate[custom[numeroFormatado]] txtCadastro_PFPasso3_OutrosRendimentosCambio" />
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <!---Start-content-RepresentanteLegal---->
                                <div class="row">
                                <div class="col1">
                                    <div class="campo-basico">
                                        <label>Representante Legal/Procurador:</label>
                                        <div class="lista-radio">
                                            <label> <input  id="rdoCadastro_PFPasso3_ProcuradorCambio_Nao" type="radio" runat="server" name="rdoRepresentanteLegalProcurador" value="Nao" onclick="return rdoCadastro_PFPasso3_RepresentanteLegalCambio_Click(this);" checked="true" /> Não</label>
                                            <label> <input  id="rdoCadastro_PFPasso3_ProcuradorCambio_Sim" type="radio" runat="server" name="rdoRepresentanteLegalProcurador" value="Sim" onclick="return rdoCadastro_PFPasso3_RepresentanteLegalCambio_Click(this);" /> Sim</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                <!---End-content-RepresentanteLegal---->

                                <!---Start-content-InformacoesRepresentante---->
                                <div id="pnlDadosRepresentanteLegalCambio" runat="server" style="display:none">
                                <div class="row">
                                    <div class="col1">
                                        <div class="menu-exportar clear">
                                            <h5>Informações Complementares</h5>
                                ...
                                <div class="row">
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="cboCadastro_PFPasso3_RepSituacaoLegalCambio">Situação Legal:</label>
                                            <div class="clear">
                                                <asp:dropdownlist id="cboCadastro_PFPasso3_RepSituacaoLegalCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" cssclass="">
                                                </asp:dropdownlist>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col2">
                                        <div class="campo-basico">
                                            <label for="txtCadastro_PFPasso3_RepNomeCompleto">Nome Completo:</label>
                                            <div class="clear">
                                                <input  id="txtCadastro_PFPasso3_RepNomeCompletoCambio" type="text" data-CaixaAlta="true" runat="server" maxlength="60" class="EstiloCampoObrigatorio" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="txtCadastro_PFPasso3_RepCPF">CPF:</label>
                                            <div class="clear">
                                                <input  id="txtCadastro_PFPasso3_RepCPFCambio" type="text" runat="server" maxlength="10" class="EstiloCampoObrigatorio Mascara_CPF ProibirLetras" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="txtCadastro_PFPasso3_RepDataNascimento">Data de Nascimento:</label>
                                            <div class="clear">
                                                <input  id="txtCadastro_PFPasso3_RepDataNascimentoCambio" type="text" runat="server" maxlength="10" class="Mascara_Data EstiloCampoObrigatorio" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="cboCadastro_PFPasso3_RepTipoDocumento">Tipo de Documento:</label>
                                            <div class="clear">
                                                <asp:dropdownlist id="cboCadastro_PFPasso3_RepTipoDocumentoCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" onchange="return cboCadastro_PFPasso3_ContasBancarias_Banco_OnChange(this);" cssclass="EstiloCampoObrigatorio">
                                                </asp:dropdownlist>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="cboCadastro_PFPasso3_RepOrgaoEmissor">Órgão Emissor:</label>
                                            <div class="clear">
                                                <asp:dropdownlist id="cboCadastro_PFPasso3_RepOrgaoEmissorCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" onchange="return cboCadastro_PFPasso3_ContasBancarias_Banco_OnChange(this);" cssclass="EstiloCampoObrigatorio">
                                                </asp:dropdownlist>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="txtCadastro_PFPasso3_RepNumeroDocumento">Nº do Documento:</label>
                                            <div class="clear">
                                                <input  id="txtCadastro_PFPasso3_RepNumeroDocumentoCambio" type="text" runat="server" maxlength="16" class="EstiloCampoObrigatorio" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col3">
                                        <div class="campo-basico">
                                            <label for="cboCadastro_PFPasso3_RepEstadoEmissao">Estado de Emissão:</label>
                                            <div class="clear">
                                                <asp:dropdownlist id="cboCadastro_PFPasso3_RepEstadoEmissaoCambio" runat="server" type="select-one" datatextfield="Value" datavaluefield="Id" onchange="return cboCadastro_PFPasso3_ContasBancarias_Banco_OnChange(this);" cssclass="EstiloCampoObrigatorio">
                                                </asp:dropdownlist>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!---End-content-InformacoesRepresentante---->

                                <p id="p1" runat="server" class="Continuar" style="padding-top:24px;width:90%">
                                    <button onclick="return GradSite_Cadastro_PFPasso3Cambio_Verificar(this)" class="botao btn-padrao btn-erica" style="width:auto; margin-left:16px">Salvar</button>
                                </p>
                                    
                                <p id="p2" runat="server" visible="false" class="row">
                                    <div class="col3" style="margin-left: 312px;">
                                        <button class="botao btn-padrao" onclick="return GradSite_Cadastro_AlterarDadosRedirecionando(this)" type="button">Alterar Dados</button>
                                    </div>
                                </p>
                            ...
                            <!---End-content-DadosFinanceirosCambio---->
<% 
    } 
%>
                                <!---Start-content-PnlContratos--->
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr class="NaoFundos">
                                                ...
                                                <td style="text-align:center"><a href="../../Resc/PDFs/Contrato_de_Intermediacao_201606.pdf" target="_blank">Visualizar</a></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center"><a href="../../Resc/PDFs/Regras_e_Parametros_201606.pdf" target="_blank">Visualizar</a></td>
                                            </tr>
                                            <tr>
                                ...
                                <!---End-content-PnlContratos--->

                                <!---Start-content-PnlCadastroRealizado--->
                                <div id="pnlCadastroRealizado" style="display:none" class="">
...
<%
    ...
    if (this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(3) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(6) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(4) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(7))
    {
%>
                                                    <a id="lnkFichaCadastralCambio" href="#" target="_blank">Ficha Cadastral (Câmbio)</a><br />
<%
    }

    //if (!this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(3)) // Só mostrar o termo de adesão caso a opção selecionada seja diferente de câmbio
    if (this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(1) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(4) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(5) || this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(6))
    {
%>
...
%>
                                ...
                                <!---End-content-PnlCadastroRealizado--->

                                <!---Start-content-PnlCadastroRealizado_Fundos--->
...
<%
    ...
    if (this.SessaoClienteLogado.CodigoTipoOperacaoCliente.Equals(7))
    {
%>
                                                    <a id="lnkFichaCadastralCambio" href="#" target="_blank">Ficha Cadastral (Câmbio)</a><br />
<%
...
<%
    ...
    {
%>
                                                    <a id="lnkTermo" href="#" target="_blank">Termo de adesão ao Contrato de Intermediação</a><br />
<%
    }
%>
                                ...
                                <!---End-content-PnlCadastroRealizado_Fundos--->

                            </div>
                            <!---End-content-DadosContratuais---->
