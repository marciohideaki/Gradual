...
namespace Gradual.Site.Www.Async
{
    public partial class Login : PaginaBase
    {
        ...
        private AutenticarUsuarioResponse LoginViaServicoSeguranca(string pEmailCodigo, string pSenha)
        {
            ...
            if (lResponseAutenticacao.StatusResposta == Gradual.OMS.Library.MensagemResponseStatusEnum.OK)
            {
                ...
                if (lSessaoResponse.StatusResposta == MensagemResponseStatusEnum.OK)
                {
                    ...
                    //TODO: colocar o codigo de edicao do CMS parametrizavel
        ...
        private AutenticarUsuarioResponse LoginViaServicoSeguranca_TecladoDinamico(string pEmailCodigo, Gradual.OMS.Seguranca.Lib.SenhaInfo pSenha)
        {
            AutenticarUsuarioDinamicoRequest lRequestAutenticacao;
            AutenticarUsuarioResponse lResponseAutenticacao;
            ...
            lRequestAutenticacao = new AutenticarUsuarioDinamicoRequest();


            SenhaInfo lSenha = pSenha.SenhaHash();

            lRequestAutenticacao.Email = pEmailCodigo;
            lRequestAutenticacao.SenhaDinamica = lSenha;
            ...
            try
            {
                ...
                lResponseAutenticacao = ServicoSeguranca.AutenticarUsuarioDinamico(lRequestAutenticacao);
            }
            catch (System.ServiceModel.CommunicationObjectFaultedException)
            {
                Application["ServicoSeguranca"] = null;
            ...
            if (lResponseAutenticacao.StatusResposta == Gradual.OMS.Library.MensagemResponseStatusEnum.OK)
            {
                ...
                if (lSessaoResponse.StatusResposta == MensagemResponseStatusEnum.OK)
                {
                    ...
                    SessaoClienteLogado.Senha = lSessaoResponse.Usuario.Senha;
                    SessaoClienteLogado.SenhaDinamica = lSessaoResponse.Usuario.SenhaDinamica;
                    SessaoClienteLogado.CodigoDaSessao = lResponseAutenticacao.Sessao.CodigoSessao;
        ...
        private void BuscarPermissoesDoUsuario()
        {
            ...
            {
                gLogger.ErrorFormat("Erro em Loing.aspx: BuscarPermissoesDoUsuario() [{0}]\r\n{1}", ex.Message, ex.StackTrace);
                throw new Exception(string.Format("Erro interno ao realizar login! [{0}]:{1}", ex.Message, ex.StackTrace ));
            }
        }
        ...
        private string ResponderEfetuarLogin()
        {
            ...
            AutenticarUsuarioResponse lResponse = null;

            try
            {
                lLogin = Request["login"];

                if (String.IsNullOrEmpty(Request["senha"]))
                {
                    SenhaInfo lSenhaDinamica = new SenhaInfo();

                    lSenhaDinamica.Caractere1.Opcao1 = Request["Senha[Caractere1][Opcao1]"];
                    lSenhaDinamica.Caractere1.Opcao2 = Request["Senha[Caractere1][Opcao2]"];
                    lSenhaDinamica.Caractere2.Opcao1 = Request["Senha[Caractere2][Opcao1]"];
                    lSenhaDinamica.Caractere2.Opcao2 = Request["Senha[Caractere2][Opcao2]"];
                    lSenhaDinamica.Caractere3.Opcao1 = Request["Senha[Caractere3][Opcao1]"];
                    lSenhaDinamica.Caractere3.Opcao2 = Request["Senha[Caractere3][Opcao2]"];
                    lSenhaDinamica.Caractere4.Opcao1 = Request["Senha[Caractere4][Opcao1]"];
                    lSenhaDinamica.Caractere4.Opcao2 = Request["Senha[Caractere4][Opcao2]"];
                    lSenhaDinamica.Caractere5.Opcao1 = Request["Senha[Caractere5][Opcao1]"];
                    lSenhaDinamica.Caractere5.Opcao2 = Request["Senha[Caractere5][Opcao2]"];
                    lSenhaDinamica.Caractere6.Opcao1 = Request["Senha[Caractere6][Opcao1]"];
                    lSenhaDinamica.Caractere6.Opcao2 = Request["Senha[Caractere6][Opcao2]"];

                    lResponse = LoginViaServicoSeguranca_TecladoDinamico(lLogin, lSenhaDinamica);
                }
                else
                {
                    lSenha = Request["senha"];
                    lResponse = LoginViaServicoSeguranca(lLogin, lSenha);
                }
                ...
                if (lResponse.StatusResposta == MensagemResponseStatusEnum.OK)
                {
                    ...
                    //lMensagem = "URL:" + RedirecionarPlataformaProduto(lResponse);
                }
        ...
        private string RedirecionarPlataformaProduto(AutenticarUsuarioResponse lResponse)
        {
            //string lReturn = "{\"Token\": \"" + lResponse.Sessao.CodigoSessao + "\"}";
            ...
            try
            {
                lReturn = ConfiguracoesValidadas.UrlPlataformaProduto + lResponse.Sessao.CodigoSessao;
            }
            catch (Exception ex)
            {
