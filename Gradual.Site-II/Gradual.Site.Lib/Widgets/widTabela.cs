...
namespace Gradual.Site.Lib.Widgets
{
    public class widTabela : WidgetBase
    {
        ...
        private string RenderizarCabecalho()
        {
            ...
            {
                string[] lColunas = this.Cabecalho.Split("|".ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
        ...
        public override string Renderizar()
        {
            ...
            {
                lRetorno = string.Format("<table id='widTabela-{0}-{1}' cellspacing='0' class='{2}' style='{3}' data-IdDaLista='{4}' data-DescricaoDaLista='{5}' data-TemplateDaLinha='{8}' data-IdTipoConteudoDaLista='{9}' data-Ordenacao='{10}'>\r\n{6}{7}\r\n</table>"
                                            , this.IdDaEstrutura
                                            , this.IdDoWidget
                                            , this.AtributoClass
                                            , this.AtributoStyle
            ...
            {
                lRetorno = string.Format("<table id='widTabela-{0}-{1}' cellspacing='0' class='{2}' style='{3}'>\r\n{4}{5}\r\n</table>"
                                            , this.IdDaEstrutura
                                            , this.IdDoWidget
                                            , this.AtributoClass
                                            , this.AtributoStyle
