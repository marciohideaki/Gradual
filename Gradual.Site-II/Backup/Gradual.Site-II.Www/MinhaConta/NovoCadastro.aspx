                    ...
                    <div class="row">
                        ...
                        <div class="col2">
                            <div class="campo-basico">
                                ...
                                <input  id="txtCadastro_PFPasso1_EmailConfirmacao" runat="server" type="text" maxlength="80" class="input-padrao input-nopaste validate[required,custom[EmailGambizento],equals[ContentPlaceHolder1_txtCadastro_PFPasso1_Email]]" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col2">
                            <div class="campo-basico campo-senha">
                                <label>Senha:</label>
                                <button type="button" title="Preenchimento obrigatório. A senha deve ter entre 6 e 20 caracteres alfanuméricos." class="interrogacao" tabindex="-1">?</button>

                                <input  id="txtCadastro_PFPasso1_Senha" runat="server" type="password"  maxlength="15" class="password validate[required,length[6, 15]]" />
                        ...
                        <div class="col2">
                            <div class="campo-basico campo-senha">
                                ...
                                <input  id="txtCadastro_PFPasso1_SenhaConfirmacao" runat="server" type="password" maxlength="15" class="validate[required,length[6, 15],equals[ContentPlaceHolder1_txtCadastro_PFPasso1_Senha]]" />
                    ...
                    <div class="row">
                        <div class="col2">
                            <div class="campo-basico campo-senha">
                                ...
                                <button type="button" title="Preenchimento obrigatório. A assinatura eletrônica é sua identificação para acessar o portal e deve ter entre 6 e 20 caracteres." class="interrogacao" tabindex="-1">?</button>

                                <input  id="txtCadastro_PFPasso1_AssEletronica" runat="server" type="password" maxlength="20" class="password validate[required,length[6, 20]]" />
                        ...
                        <div class="col2">
                            <div class="campo-basico campo-senha">
                                ...
                                <input  id="txtCadastro_PFPasso1_AssEletronicaConfirmacao" runat="server" type="password" maxlength="20" class="validate[required,length[6, 20],equals[ContentPlaceHolder1_txtCadastro_PFPasso1_AssEletronica]]" />
