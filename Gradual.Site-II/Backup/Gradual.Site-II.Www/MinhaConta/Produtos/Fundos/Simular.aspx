<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Simular.aspx.cs" Inherits="Gradual.Site.Www.MinhaConta.Produtos.Fundos.Simular" MasterPageFile="~/PaginaInterna.Master" %>
...
<section class="PaginaConteudo">
        ...
        <asp:Repeater runat="server" ID="rptListaDeValoresGrafico">
            <itemtemplate>
                <tr data-label="<%#Eval("NomeFundo") %>" data-valor="<%#Eval("Valor") %>">
                    ...
                    <td class="grafico-valor"> R$ <%# Eval("Valor")%> </td>
                </tr>
            </itemtemplate>
        </asp:Repeater>
    </table>
    ...
    <div id="pnlSimulacaoResultados" runat="server" style="display:none">

        <div  id="chrtRentabilidadeSimular" style=" width: 970px; height:200px; margin-bottom:10px"></div>
        <div id="chartLegend" style="margin-bottom: 20px;width:400px"></div> 
...
<ucSauron:Sauron id="Sauron1" runat="server" nomedapagina="Prod - Fds - Simular" />
