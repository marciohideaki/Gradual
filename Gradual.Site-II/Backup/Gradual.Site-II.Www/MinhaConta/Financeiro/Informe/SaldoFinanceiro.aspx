<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaInterna.Master" AutoEventWireup="true" CodeBehind="SaldoFinanceiro.aspx.cs" Inherits="Gradual.Site.Www.MinhaConta.Financeiro.Informe.SaldoFinanceiro" %>
...
<section class="PaginaConteudo">
        ...
        <div class="col1">
            <div class="menu-exportar clear">
                ...
                <ul>
                    ...
                    <li class="interrogacao"><button type="button" title="Ajuda?">?</button></li>
                    <li class="exportar">
    ...
    <div class="row">
        <div class="col1">
            <div id="abas" class="abas-simples">
...
<ucSauron:Sauron id="Sauron1" runat="server" nomedapagina="Financeiro - Saldo" />
