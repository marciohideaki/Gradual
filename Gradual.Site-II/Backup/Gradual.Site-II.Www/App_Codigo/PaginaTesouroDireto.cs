...
{
    public class PaginaTesouroDireto : PaginaBase
    {
        #region Propriedades
        ...
        */
        ...
        public List<RendaFixaInfo> ConsultarRendaFixa(RendaFixaInfo pParametros)
        {
            ...
            return lDb.ConsultarRendaFixa(pParametros);
        }
        ...
        public PaginaTesouroDireto()
        {
            this.IdentificadorDaPagina = "PaginaTesouroDireto";
        }
