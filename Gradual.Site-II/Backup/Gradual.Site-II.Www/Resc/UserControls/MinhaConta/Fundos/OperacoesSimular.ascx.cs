...
{
    public partial class OperacoesSimular : System.Web.UI.UserControl
    {
        #region Propriedade
        ...
        protected void tbnFitroConsultaSimulacao_Click(object sender, EventArgs e)
        {
            ...
            var lResponse = lBase.ListarSimularAplicacaoGrid(lRequest);
            ...
            PaginaBase lPageBase = (PaginaBase)this.Page;

            lPageBase.RodarJavascriptOnLoad("MinhaConta_Fundos_Simular_RecarregaGridEscolhidos()");
        }
        #endregion
