    ...
    if (R.svg) {
        ...
        Element[proto].getBBox = function () {
            ...
            if (this.type == "text") {
                ...
                //luciano:
                if(bbox.height == 0) bbox.height = 12;  //chutando de acordo com o tamanho da fonte que vou usar
                if(bbox.width  == 0) bbox.width  = 340; //chutando de acordo com o tamanho da fonte que vou usar
            }
            hide && this.hide();
            return bbox;
        };
