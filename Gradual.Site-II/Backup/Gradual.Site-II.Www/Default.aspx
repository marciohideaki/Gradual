...
<%@ Register src="Resc/UserControls/RodapeDoSite.ascx"  tagname="RodapeDoSite"  tagprefix="ucRodape" %>
...
<html>
    ...
    <body onload="Page_Load()">
        ...
        <div id="conteudo">
            ...
            <div class="borda-full clear" style="padding-bottom:40px">
                ...
                <div style="display:inline-block; text-align:center; width:100%; padding-top:24px; margin-bottom:-16px; border-top: 1px solid #dcdad8">
                    ...
                    <div class="destaque-fundo">
                        <a href="PlataformasdeNegociacao/GTI">
                            <img src="Resc/Skin/<%=this.SkinEmUso %>/Img/bannerzinho-GTI-op2.jpg" />
                        </a>
                    </div>
        ...
        <ucrodape:rodapedosite id="RodapeDoSite1" runat="server" />
