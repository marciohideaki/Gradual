...
{
    public partial class ResultadoOrdensNovoOMS : PaginaBaseAutenticada
    {
        #region | Propriedades
        ...
        private List<OrdemInfo> SessionUltimoResultadoDeBusca
        {
            get
            {
                return (List<OrdemInfo>)Session["UltimoResultadoDeBuscaDeOrdensNovoOMS"];
            }

            set
            {
                Session["UltimoResultadoDeBuscaDeOrdensNovoOMS"] = value;
            }
        }
        ...
        private int? GetBolsa
        {
            get
            {
                ...
                {
                    if (this.GetOrigem.Equals("GTI") || this.GetOrigem.Equals("HB") || this.GetOrigem.Equals("PORTAL"))
                    {
        ...
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            this.btnCancelarOrdensNovoOMS.Visible = base.UsuarioPode("Cancelar", "807cda55-811c-4ca9-8867-ad16d456c68d");
        ...
        private IEnumerable<OrdemInfo> FiltrarSentidoBolsaOrigem(List<OrdemInfo> pLista)
        {
            ...
            try
            {
                if (this.GetOrigem == "GTI")
                {
                    if (this.GetBolsa == 0)
                    {
                        lRetorno = from a in lRetorno where a.ChannelID.Equals(0) && a.CompIDOMS.Equals("GTI") select a;
                    }
                    else
                    {
                        lRetorno = from a in lRetorno where 
                                       ...
                                       a.ChannelID.Equals(PortaBovespaGTIClienteHFT1)) && a.CompIDOMS.Equals("GTI") select a;
                    }
                }
                else if (this.GetOrigem == "HB")
                {
                    ...
                    else
                    {
                        ...
                        //lRetorno = from a in lRetorno where (a.ChannelID.Equals(PortaBovespaGTIAssessor) || a.ChannelID.Equals(PortaBovespaGTICliente) || a.ChannelID.Equals(PortaBovespaHB))  select a;
                    }
                }
                else if (this.GetOrigem == "PORTAL")
                {
                    if (this.GetBolsa == 0)
                    {
                        lRetorno = from a in lRetorno where a.ChannelID.Equals(0) && a.CompIDOMS.Equals("PORTAL") select a;
                    }
                    else
                    {
                        lRetorno = from a in lRetorno where (a.ChannelID.Equals(PortaBovespaGTIAssessor) || a.ChannelID.Equals(PortaBovespaGTICliente) || a.ChannelID.Equals(PortaBovespaHB)) && a.CompIDOMS.Equals("PORTAL") select a;
                    }
                }
