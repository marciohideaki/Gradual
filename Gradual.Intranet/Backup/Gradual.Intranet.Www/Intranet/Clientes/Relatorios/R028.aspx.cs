...
{
    public partial class R028 : PaginaBaseAutenticada
    {
        #region | Atributos
        ...
        private IEnumerable<TransporteRelatorio_028> ListaDeResultados
        {
            get
            {
                return (IEnumerable<TransporteRelatorio_028>)this.Session["ListaDeResultados_Relatorio_028"];
            }

            set
            {
                this.Session["ListaDeResultados_Relatorio_028"] = value;
            }
        }
        ...
        private void ResponderBuscarItensParaListagemSimples()
        {
            ...
            if (MensagemResponseStatusEnum.OK.Equals(lResponse.StatusResposta))
            {
                ...
                {
                    var lLista = new List<TransporteRelatorio_028>();

                    lResponse.Resultado.ForEach(delegate(ClienteRenovacaoCadastralInfo cliInfo) { lLista.Add(new TransporteRelatorio_028(cliInfo)); });
        ...
        private List<TransporteRelatorio_028> BuscarParte(int pParte)
        {
            List<TransporteRelatorio_028> lRetorno = new List<TransporteRelatorio_028>();
