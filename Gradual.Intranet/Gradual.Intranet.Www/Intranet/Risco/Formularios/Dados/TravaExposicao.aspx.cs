...
{
    public partial class TravaExposicao : PaginaBaseAutenticada
    {
        #region Propriedades
        ...
        private string ResponderSalvarTravaDadosExposicao()
        {
            ...
            try
            {
                ...
                var lRetornoInclusao = base.ServicoRegrasRisco.SalvarTravaExposicao(lRequest);
        ...
        private string ResponderCarregarHtmlComDados()
        {
            ...
            var lResponse = base.ServicoRegrasRisco.ReceberTravaExposicao(lRequest);
