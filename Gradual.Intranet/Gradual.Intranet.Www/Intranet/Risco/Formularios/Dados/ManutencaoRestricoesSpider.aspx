<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManutencaoRestricoesSpider.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Risco.Formularios.Dados.ManutencaoRestricoesSpider" %>

    <form id="form1" runat="server">
    <input type="hidden" id="hidClienteLimites" runat="server" />

        <ul class="pnlFormulario_Abas_Container">
            <li class="Selecionada"><a href="#" rel="pnlCliente_Restricoes_Grupo" onclick="return pnlFormulario_Abas_li_a_Restricoes_Spider_Click(this)">Regra para o Grupo</a></li>
            <li><a href="#" rel="pnlCliente_Restricoes_Grupo_Global" onclick="return pnlFormulario_Abas_li_a_Restricoes_Spider_Click(this)">Regra para o Grupo Global</a></li>
            <li><a href="#" rel="pnlCliente_Restricoes_Individual" onclick="return pnlFormulario_Abas_li_a_Restricoes_Spider_Click(this)">Regra Individual</a></li>
        </ul>
        ...
        <div id="pnlRestricoesPorCliente" style="padding-top:3%">
                <div id="pnlCliente_Restricoes_RestricaoPorAtivo">
                    ...
                    <div id="pGradIntra_Risco_ItensDoGrupo_Grupos">
                        ...
                        <p class="ui-widget" style="width:350px" >
                            <select class="GradIntra_ComboBox_Pesquisa AtivarAutoComplete" id="GradIntra_Risco_ItensDoGrupoRestricoesSpider_Grupos" style="width:250px" >
                        ...
                        <p style="float: left; width: 20%; margin-left: -25px; margin-top: 5px;">
                            <button class="" id="GradIntra_Risco_Restricoes_SelecionarGrupo" onclick="return GradIntra_Risco_Restricoes_SelecionarGrupo_Spider_Click(this)">Selecionar</button>
                        </p>
                    </div>
                    ...
                    <p id="pCliente_Restricoes_RestricaoPorCliente" >
                        ...
                        <input type="text" id="txtCliente_Restricoes_RestricaoPorClienteSpider" style="width: 12em;" maxlength="10" />
                    </p>
                    <br />
                    <p id="pCliente_Restricoes_RestricaoPorAtivo" style="display:none">
                        <label style="width:76px">Instrumento:</label>
                        <input type="text" id="txtCliente_Restricoes_RestricaoPorAtivoSpider" style="width: 12em; text-transform: uppercase" maxlength="10" />
                    </p>

                    <%--style="display:none;"--%>
                    <div class="custom-checkbox" id="DivGradIntraRisco_Restricao_Global_OMS_Spider" style="display:none">
                        <input type="checkbox" id="ckbGradIntraRisco_Restricao_Global_OMS_Spider" propriedade="ckbGradIntraRisco_Restricao_Global_OMS" checked="checked">
                        <label for="ckbGradIntraRisco_Restricao_Global_OMS">Restringir Global para o OMS</label>
                    </div>
                    <p class="RadiosRestricaoPorAtivosSpider" style="width: 300px;">
                ...
                <p style="width: 50px; float: left; margin-top: -1px">
                    <button class="" id="btnGradIntra_Risco_ItemDeGrupo_AdicionarItem" onclick="return GradIntra_Risco_Restricoes_RegraDeGrupo_AdicionarItemSpider_Click(this);">Gravar</button>
                </p>
                <div id="DivtblGradIntra_Risco_ItemCliente_Spider" style="display:none; margin-top:75px;">
                <%--margin: 0.75em 3em 1em 3em; width: 85%; z-index:-40;--%>
                <table id="tblGradIntra_Risco_ItemClienteSpider" class="GridIntranet" style="width: 70%; margin: 0em 0em 0em 0em; z-index:-40;" cellspacing="0" >
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr class="tdGradIntra_Risco_ItemCliente_TrMatrizSpider"        style="display:none;">
                            ...
                            <td class="tdGradIntra_Risco_ItemCliente_Excluir"     align="center"><input type="button" onclick="return GradIntra_Risco_Restricoes_ItensDoCliente_Excluir_Spider_Click(this);" class="IconButton Excluir" style="float: none;" /></td>
                        </tr>
                    </tbody>
                </table> 
                </div>
                <%--margin: 0.75em 3em 1em 3em; width: 85%; z-index:-40;--%>
                <div id="DivtblGradIntra_Risco_ItemGrupoSpider" style="margin-top:70px">
                    <table id="tblGradIntra_Risco_ItemRegraGrupoSpider" class="GridIntranet" style="width: 70%" cellspacing="0">
                        <thead>
                            <tr>
                                <td style="display:none"></td>
                                <td style="display:none"></td>
                        ...
                        <tbody>
                            <tr class="tdGradIntra_Risco_ItemRegraGrupo_TrMatrizSpider"        style="display: none;">
                                ...
                                <td class="tdGradIntra_Risco_ItemRegraGrupo_Excluir"     align="center"><input type="button" onclick="return GradIntra_Risco_Restricoes_ItensDoGrupo_Excluir_Spider_Click(this);" class="IconButton Excluir" style="float: none;" /></td>
                            </tr>
                        </tbody>
                    </table>    
                </div>
                <div id="DivtblGradIntra_Risco_ItemGrupo_GlobalSpider" style="display: none; margin-top: 50px">
                    <table id="tblGradIntra_Risco_ItemGrupo_GlobalSpider" class="GridIntranet" style="width: 70%" cellspacing="0">
                        <thead>
                            <tr>
                                <td style="display:none"></td>
                                <td style="display:none"></td>
                        ...
                        <tbody>
                            <tr class="tdGradIntra_Risco_ItemGrupo_Global_TrMatrizSpider"        style="display: none;">
                                ...
                                <td class="tdGradIntra_Risco_ItemGrupo_Global_Excluir"     align="center"><input type="button" onclick="return GradIntra_Risco_Restricoes_ItensDoGrupo_Global_Excluir_Spider_Click(this);" class="IconButton Excluir" style="float: none;" /></td>
                            </tr>
                        </tbody>
                    </table>    
                </div>
