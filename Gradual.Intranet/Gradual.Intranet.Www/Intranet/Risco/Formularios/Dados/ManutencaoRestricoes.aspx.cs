...
{
    public partial class ManutencaoRestricoes : PaginaBaseAutenticada
    {
        #region Propriedades
        ...
        private string ResponderExcluirRegraGrupoItemGlobal()
        {
            ...
            try
            {
                ...
                var lResponse = base.ServicoRegrasRisco.RemoverRegraGrupoItemGlobal(lRequest);
        ...
        private string ResponderCarregarListaRegraGrupoItemGlobal()
        {
            ...
            try
            {
                ...
                var lResponse = base.ServicoRegrasRisco.ListarRegraGrupoItemGlobal(lRequest);
        ...
        private string ResponderCarregarListaClienteBloqueioInstrumento()
        {
            ...
            try
            {
                ...
                var lReponse = base.ServicoRegrasRisco.ListarBloqueioClienteInstrumentoDirecao(lRequest);
        ...
        private string ResponderCarregarListaRegraGrupoItem()
        {
            ...
            try
            {
                ...
                var lReponse = base.ServicoRegrasRisco.ListarRegraGrupoItem(lRequest);
        ...
        private string ResponderSalvarClienteBloqueioInstrumentoDirecao()
        {
            ...
            try
            {
                ...
                lRequestBloqueioCliente.Objeto.CdAtivo   = this.GetAtivo;
                lRequestBloqueioCliente.Objeto.Direcao   = this.GetSentido;
                lRequestBloqueioCliente.Objeto.IdCliente = this.GetIdCliente.Value;

                var lRetornoInclusao = base.ServicoRegrasRisco.SalvarClienteBloqueioInstrumentoDirecao(lRequestBloqueioCliente);
