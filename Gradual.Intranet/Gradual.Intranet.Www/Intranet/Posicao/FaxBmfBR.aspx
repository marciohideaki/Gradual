<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaxBmfBR.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Posicao.FaxBmfBR" %>
...
<body>
    ...
    <div class="Relatorio">
            <div id="divGradItra_Clientes_Relatorios_Financeiro_FecharRelatorio" class="FecharRelatorios">
                ...
                <a href="#" onclick="GradItra_Clientes_Relatorios_Financeiro_Fax_Bmf_BR_Click_Print(this);">Imprimir PDF</a> |
