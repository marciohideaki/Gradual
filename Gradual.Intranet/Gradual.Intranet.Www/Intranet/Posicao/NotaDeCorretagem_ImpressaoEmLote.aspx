<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotaDeCorretagem_ImpressaoEmLote.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Posicao.NotaDeCorretagemImpressaoEmLote" %>
        ...
        <div class="Relatorio" style="background-color: #FFF;">
            ...
            <div style="padding-left:20px;" class="RelatorioImpressao">
                ...
                <%--<h2 class="InformacoesDoCliente">
                    <div><label style="padding-right:17px;">Data:</label><span><%# Eval("DataEmissaoNota") %></span></div>
