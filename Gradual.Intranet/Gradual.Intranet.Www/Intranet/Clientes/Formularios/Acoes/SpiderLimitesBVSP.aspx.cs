...
{
    public partial class SpiderLimitesBVSP : PaginaBaseAutenticada
    {
        #region | Atributos
        ...
        private void CarregarDadosViaServico()
        {
            ...
            {   //--> Definindo a apresenteção das permissões.
                ...
                this.gRetornoPermissoesRiscoCliente = new ServicoRegrasRisco().ListarPermissoesRiscoClienteSpider(new ListarPermissoesRiscoClienteRequest() { CodigoCliente = this.GetCodBovespa });
            }
        ...
        private void ConfigurarLimitesNaTela(List<TransporteConfigurarLimites> pParametrosLimites)
        {
            pParametrosLimites.ForEach(delegate(TransporteConfigurarLimites tcl)
            {
                switch (tcl.TipoLimite)
                {
                    case Gradual.Intranet.Contratos.Dados.Enumeradores.eTipoLimite.OperarCompraAVista:
                        this.hddCliente_Spider_Limites_Bosvespa_AVista_DataDeVencimento.Value = DateTime.Today.ToString("dd/MM/yyyy");
                        this.txtCliente_Spider_Limites_Bosvespa_AVista_DataDeVencimento.Value = tcl.Vencimento;
                        this.hddCliente_Spider_Limites_Bosvespa_AVista_Limite.Value =
                        this.txtCliente_Spider_Limites_Bosvespa_AVista_Limite.Value = tcl.Limite;
                        this.chkCliente_Spider_Limites_Bosvespa_AVista_Opera.Checked = tcl.StAtivo;
                        break;
                    case Gradual.Intranet.Contratos.Dados.Enumeradores.eTipoLimite.OperarCompraOpcao:
                        this.hddCliente_Spider_Limites_Bovespa_Opcao_DataDeVencimento.Value = DateTime.Today.ToString("dd/MM/yyyy");
                        this.txtCliente_Spider_Limites_Bovespa_Opcao_DataDeVencimento.Value = tcl.Vencimento;
                        this.hddCliente_Spider_Limites_Bovespa_Opcao_Limite.Value =
                        this.txtCliente_Spider_Limites_Bovespa_Opcao_Limite.Value = tcl.Limite;
                        this.chkCliente_Spider_Limites_Bovespa_Opcao_Opera.Checked = tcl.StAtivo;
                        break;
                    case Gradual.Intranet.Contratos.Dados.Enumeradores.eTipoLimite.OperarDescobertoAvista:
                        this.hddCliente_Spider_Limites_Bosvespa_AVista_DataDeVencimentoDescoberto.Value = DateTime.Today.ToString("dd/MM/yyyy");
                        this.txtCliente_Spider_Limites_Bosvespa_AVista_DataDeVencimentoDescoberto.Value = tcl.Vencimento;
                        this.hddCliente_Spider_Limites_Bosvespa_AVista_LimiteDescoberto.Value =
                        this.txtCliente_Spider_Limites_Bosvespa_AVista_LimiteDescoberto.Value = tcl.Limite;
                        this.chkCliente_Spider_Limites_Bosvespa_AVista_OperaDescoberto.Checked = tcl.StAtivo;
                        break;
                    case Gradual.Intranet.Contratos.Dados.Enumeradores.eTipoLimite.OperarDescobertoOpcao:
                        this.hddCliente_Spider_Limites_Bovespa_Opcao_DataDeVencimentoDescoberto.Value = DateTime.Today.ToString("dd/MM/yyyy");
                        this.txtCliente_Spider_Limites_Bovespa_Opcao_DataDeVencimentoDescoberto.Value = tcl.Vencimento;
                        this.hddCliente_Spider_Limites_Bovespa_Opcao_LimiteDescoberto.Value =
                        this.txtCliente_Spider_Limites_Bovespa_Opcao_LimiteDescoberto.Value = tcl.Limite;
                        this.chkCliente_Spider_Limites_Bovespa_Opcao_OperaDescoberto.Checked = tcl.StAtivo;
                        break;
                    case Gradual.Intranet.Contratos.Dados.Enumeradores.eTipoLimite.ValorMaximoOrdem:
                        this.hddCliente_Spider_Limites_Bosvespa_ValorMaximoDaOrdem_DataDeVencimento.Value = DateTime.Today.ToString("dd/MM/yyyy");
                        this.txtCliente_Spider_Limites_Bosvespa_ValorMaximoDaOrdem_DataDeVencimento.Value = tcl.Vencimento;
                        this.hddCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Value =
                        this.txtCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Value = tcl.Limite;
                        this.chkCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Checked = tcl.StAtivo;
                        break;
                }
            });
            ...
            if (lResponse.StatusResposta == MensagemResponseStatusEnum.OK)
            {
                ...
                {
                    this.hddCliente_Spider_Limites_Bosvespa_ValorMaximoDaOrdem_DataDeVencimento.Value = lResponse.FatFinger.DataVencimento.ToString("dd/MM/yyyy");// DateTime.Today.ToString("dd/MM/yyyy");
                    this.txtCliente_Spider_Limites_Bosvespa_ValorMaximoDaOrdem_DataDeVencimento.Value = lResponse.FatFinger.DataVencimento.ToString("dd/MM/yyyy");
                    this.hddCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Value =
                    this.txtCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Value = lResponse.FatFinger.ValorMaximo.ToString("N2");
                    this.chkCliente_Spider_Limites_Bovespa_ValorMaximoDaOrdem.Checked = true;
                }
            }
        }
        ...
        {
            {
                this.txtCliente_Spider_Detalhes_AVista_Alocado.Value =
                this.txtCliente_Spider_Detalhes_AVista_Disponivel.Value =
                this.txtCliente_Spider_Detalhes_AVista_Limite.Value =

                this.txtCliente_Spider_Detalhes_Opcoes_Alocado.Value =
                this.txtCliente_Spider_Detalhes_Opcoes_Disponivel.Value =
                this.txtCliente_Spider_Detalhes_Opcoes_Limite.Value =

                this.txtCliente_Spider_Detalhes_AVista_Descoberto_Alocado.Value =
                this.txtCliente_Spider_Detalhes_AVista_Descoberto_Disponivel.Value =
                this.txtCliente_Spider_Detalhes_AVista_Descoberto_Limite.Value =

                this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Alocado.Value =
                this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Disponivel.Value =
                this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Limite.Value = "0,00";
            }
            ...
            pParametrosDetalhesDoLimite.ForEach(delegate(TransporteRelatorio_005 tr5)
            {
                if (tr5.Parametro.Contains("compra"))
                {
                    ...
                    {
                        this.txtCliente_Spider_Detalhes_AVista_Alocado.Value = tr5.ValorAlocado;
                        this.txtCliente_Spider_Detalhes_AVista_Disponivel.Value = tr5.ValorDisponivel;
                        this.txtCliente_Spider_Detalhes_AVista_Limite.Value = tr5.ValorLimite;
                    }
                    else
                    {
                        this.txtCliente_Spider_Detalhes_Opcoes_Alocado.Value = tr5.ValorAlocado;
                        this.txtCliente_Spider_Detalhes_Opcoes_Disponivel.Value = tr5.ValorDisponivel;
                        this.txtCliente_Spider_Detalhes_Opcoes_Limite.Value = tr5.ValorLimite;
                    }
                }
                else
                {
                    if (tr5.Parametro.Contains("vista"))
                    {
                        this.txtCliente_Spider_Detalhes_AVista_Descoberto_Alocado.Value = tr5.ValorAlocado;
                        this.txtCliente_Spider_Detalhes_AVista_Descoberto_Disponivel.Value = tr5.ValorDisponivel;
                        this.txtCliente_Spider_Detalhes_AVista_Descoberto_Limite.Value = tr5.ValorLimite;
                    }
                    else
                    {
                        this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Alocado.Value = tr5.ValorAlocado;
                        this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Disponivel.Value = tr5.ValorDisponivel;
                        this.txtCliente_Spider_Detalhes_Opcoes_Descoberto_Limite.Value = tr5.ValorLimite;
                    }
                }
            });
        }
        ...
        {
            this.rptCliente_Spider_Permissoes.DataSource = pPermissoesTodas;
            this.rptCliente_Spider_Permissoes.DataBind();
        }
        ...
        private SalvarParametroRiscoClienteResponse SalvarExpirarParametrosRisco(TransporteLimiteBovespa pParametro)
        {
            ...
            {   //--> Expirar Limite
                ...
                {
                    lServicoRegrasRisco.SalvarExpirarLimiteSpider(
        ...
        private MensagemResponseBase SalvarPermissoes(TransporteLimiteBovespa pParametro)
        {
            ...
            MensagemResponseBase lresPer = ServicoRegrasRisco.SalvarPermissoesRiscoAssociadasSpider(lreqSalvar);
            return lresPer;
        }
        ...
        private void ConfigurarRestricoesNaTela()
        {
            {   //--> Configurando o combo com as restrições por grupo.
                var lListaRestricoesGrupo = new ServicoRegrasRisco().ListarGruposSpider(new ListarGruposRequest() { });
