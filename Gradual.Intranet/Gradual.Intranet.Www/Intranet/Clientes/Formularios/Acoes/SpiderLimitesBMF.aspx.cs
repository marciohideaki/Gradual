...
{
    public partial class SpiderLimitesBMF : PaginaBaseAutenticada
    {
        #region Atributos
        ...
        private string ResponderSelecionaContratoLimitesBmf()
        {
            ...
            try
            {
                List<ClienteParametroLimiteBMFInfo> lListContrato = Session["Spider_ListaLimites_" + GetCodBmf] as List<ClienteParametroLimiteBMFInfo>;

                List<ClienteParametroBMFInstrumentoInfo> lListInstrumento = Session["Spider_ListaLimitesInstrumentos_" + GetCodBmf] as List<ClienteParametroBMFInstrumentoInfo>;
        ...
        private string ResponderRemoveIntrumentoLimitesBmf()
        {
            ...
            try
            {
                List<ClienteParametroBMFInstrumentoInfo> listInstrumentos = Session["Spider_LimitesInstrumento_" + GetCodBmf] as List<ClienteParametroBMFInstrumentoInfo>;
        ...
        private void CarregaInstrumentosLimiteBmf()
        {
            try
            {
                ...
                this.txtCliente_Spider_Qtde_Compra.Value = lContratoCompra.QuantidadeDisponivel.ToString();
                                
                this.txtCliente_Spider_Qtde_Venda.Value = lContratoVenda.QuantidadeDisponivel.ToString();
                                
                this.txtCliente_Spider_Qtde_Maxima_Ordem_Contrato.Value = lContratoCompra.QuantidadeMaximaOferta.ToString();
                                
                this.txtCliente_Spider_Data_validade.Value = lContratoCompra.DataValidade.ToString("dd/MM/yyyy");
