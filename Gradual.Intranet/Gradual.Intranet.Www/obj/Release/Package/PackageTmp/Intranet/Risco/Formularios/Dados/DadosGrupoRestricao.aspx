<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DadosGrupoRestricao.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Risco.Formularios.Dados.DadosGrupoRestricao" %>
...
<form id="form1" runat="server">
    ...
    <p style="width: 30px; float: left; margin-top: -0.5px;">
        <button onclick="return btnSalvar_Risco_DadosGruposRestricoes_Click(this)">Gravar</button>
    </p>
    ...
    <script>Risco_BuscarItensGruposDeRiscoRestricoes();</script>
</form>
