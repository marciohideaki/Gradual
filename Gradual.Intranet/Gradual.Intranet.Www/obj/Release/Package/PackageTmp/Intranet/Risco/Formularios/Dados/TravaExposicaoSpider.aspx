<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravaExposicaoSpider.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Risco.Formularios.Dados.TravaExposicaoSpider" %>
            ...
            <div id="pnlCliente_Restricoes_TravaExposicao">
                <h4>Trava exposição</h4>
                    ...
                    <p class="BotoesSubmit" style="margin-top:3em">
                        <button id="btnCliente_Restricoes" onclick="return GradIntra_Risco_Restricoes_TravaExposicaoSpider_Salvar_Click(this)">Gravar</button>
                    </p>
            </div>
        </div>
    </form>
