<%@ Page Language="C#" enableviewstate="false" AutoEventWireup="true" CodeBehind="DadosCompletos_Grupo.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Risco.Formularios.Dados.DadosCompletos_Grupo" %>
...
<form id="form1" runat="server">
    ...
    <p style="width: 25.5em;float:left;">
        <input type="text" id="txtRisco_DadosCompletos_Grupo_Descricao" Propriedade="Descricao" maxlength="100" class="validate[required,length[5,100]]" style="width:100%" />
    </p>
    <p style="width: 30px; float: left; margin-top: -0.5px;">
        <button onclick="return btnSalvar_Risco_DadosCompletos_Click(this)">Gravar</button>
    </p>
    ...
    <div style="margin: 71px 100px 0pt 37px;">
        <table cellspacing="0" class="GridIntranet GridIntranet_CheckSemFundo" style="width:99%;">
            <thead>
                <div>
                    <table id="tblRisco_ConfigurarGridDeResultados" style="overflow:hidden;"></table>
                    <div id="pnlRisco_ConfigurarGridDeResultados_Pager" style="overflow:hidden;"></div>
                </div>
            </thead>
        </table>
    </div>
    ...
    <script>Risco_BuscarItensGruposDeRisco();</script>
</form>
