<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonitoramentoIntradiario.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Risco.Formularios.Dados.MonitoramentoIntradiario" %>
...
<head runat="server">
    ...
    <title>Gradual Investimentos - Monitoramento Intradiário</title>
</head>
<body>
    <form id="form1" runat="server">
    <h1 style="width: 100%; height: 3em;"><span>Header Intranet Gradual</span></h1>
        
    <h3 style="margin: 10px 0pt 15px 25px; height: 15px">- Monitoramento Intrandiário - <div id="pnlNomePagina" style="display:inline-block"></div></h3>
    ...
    <div id="pnlRisco_Monitoramento_Risco_LucroPrejuizo_Pesquisa" class="Busca_Formulario" style="width: 90%; height: 3em; margin-left:10px">
        <div style="margin-top:7px;">
            ...
            <input  id="chkRisco_Monitoramento_Intradiario_AtualizarAutomaticamente" type="checkbox" onclick="return chkRisco_Monitoramento_Intradiario_AtualizarAutomaticamente_Click(this);" checked="checked" />
            
            <label for="chkRisco_Monitoramento_Intradiario_AtualizarAutomaticamente">Atualizar automaticamente.</label>&nbsp;&nbsp;
            
            <label  id="lblRisco_Monitoramento_Intradiario_AtualizarAutomaticamente_ContagemRegressiva" style="width: 25%; float:right"></label>
    ...
    <div style="margin-top:6.0em;  position:absolute; background-color: White; width: 100%" >
        <div id="div_Risco_MonitoramentoIntradiario_Resultados" style="margin-top: 1em; margin-left: 1em; margin-bottom: 2em; display: none; ">
            <table id="tblBusca_MonitoramentoIntradiario_Resultados"></table>
        </div>
