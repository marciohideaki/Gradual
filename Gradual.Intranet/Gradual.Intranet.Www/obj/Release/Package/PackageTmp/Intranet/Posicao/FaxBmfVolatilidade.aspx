<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaxBmfVolatilidade.aspx.cs" Inherits="Gradual.Intranet.Www.Intranet.Posicao.FaxBmfVolatilidade" %>
...
<body>
    ...
    <div class="Relatorio">
            <div id="divGradItra_Clientes_Relatorios_Financeiro_FecharRelatorio" class="FecharRelatorios">
                ...
                <a href="#" onclick="GradItra_Clientes_Relatorios_Financeiro_Fax_Bmf_Volatilidade_Click_Print(this);">Imprimir PDF</a> |
                ...
                <table cellspacing="0">
                    ...
                    <thead>
                        <tr style="font-size:0.8em">
                            <td><%# DataBinder.Eval(Container.DataItem, "CabecalhoSentido").ToString() == "C" ? "COMPRA" : "VENDA" %></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="tdLabel ValorNumerico"><%# DataBinder.Eval(Container.DataItem, "CabecalhoSentido").ToString() == "C" ? "" : "-" %><%# DataBinder.Eval(Container.DataItem, "SomaQuantidade")%> </td>
