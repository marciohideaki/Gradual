...
-- Autor Ultima Alteração   : Ismael Gregório Pereira
-- Data da ultima alteração : 20/01/2011
-- Motivo                   : Inclusão do campo 'id_assessorinicial'
...
ALTER PROCEDURE [dbo].[cliente_upd_sp]
	...
	, @id_assessorinicial         numeric(5, 0) = null
...
AS
    ...
    ,      [tb_cliente].[dt_primeiraexportacao]       = @dt_primeiraexportacao
	...
	,      [tb_cliente].[id_assessorinicial]         = isnull(@id_assessorinicial,[tb_cliente].[id_assessorinicial])
    ...
    ,      [tb_cliente].[st_pessoavinculada]         = @st_pessoavinculada
