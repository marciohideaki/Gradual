-- Descrição:       Realiza a seleção dos dados de situação financeira patrimonial da base
...
-- Motivo                   : É necessário o filtro pelo cliente
...
CREATE PROCEDURE cliente_situacaofinanceirapatrimonial_lst_sp
	@id_cliente bigint
AS
