...
namespace Gradual.Intranet.Servicos.BancoDeDados.Persistencias
{
    public partial class ClienteDbLib
    {
        ...
        /// <returns></returns>
        public static ReceberObjetoResponse<ViewFichaCadastralCompletaInfo> ReceberViewFichaCadastralCompleta(ReceberEntidadeRequest<ViewFichaCadastralCompletaInfo> pParametros)
        {
            try
            {
        ...
        private static void PreencheTipoEndereco()
        {
            ConsultarObjetosResponse<TipoEnderecoInfo> lRespostaGenerica =
                ConsultarTipoEndereco(new ConsultarEntidadeRequest<TipoEnderecoInfo>());
        ...
        private static void PreencheTipoTelefone()
        {
            ConsultarObjetosResponse<TipoTelefoneInfo> lRespostaGenerica =
                ConsultarTipoTelefone(new ConsultarEntidadeRequest<TipoTelefoneInfo>());
        ...
        {
            ConsultarObjetosResponse<ContratoInfo> lRespostaGenerica = ConsultarContrato(new ConsultarEntidadeRequest<ContratoInfo>());
            LstContrato.Clear();
            lRespostaGenerica.Resultado.ForEach
        ...
        /// </summary>
        private static void PreencheListasSinacor(eInformacao eNum)
        {
            ConsultarObjetosResponse<SinacorListaInfo> lRespostaGenerica =
        ...
        private static ReceberObjetoResponse<ViewFichaCadastralCompletaInfo> PreencheViewPessoaFisica(ReceberObjetoResponse<FichaCadastralInfo> pParametros)
        {
            try
            {
                ...
                lRetorno.DadosBasicos_DesejaAplicar = pParametros.Objeto.ClienteResponse.Objeto.TpDesejaAplicar;
                ...
                pParametros.Objeto.ClienteSituacaoFinanceiraPatrimonialResponse.Resultado.ForEach(delegate(ClienteSituacaoFinanceiraPatrimonialInfo lInfo)
                    {
                        lRetorno.InformacoesPatrimoniais_BensImoveis              = lInfo.VlTotalBensImoveis.Value.ToString();
                        lRetorno.InformacoesPatrimoniais_BensMoveis               = lInfo.VlTotalBensMoveis.Value.ToString();
                        ...
                        lRetorno.InformacoesPatrimoniais_Salario                  = lInfo.VlTotalSalarioProLabore.Value.ToString();
                        lRetorno.InformacoesPatrimoniais_Aplicacoes               = lInfo.VlTotalAplicacaoFinanceira.Value.ToString();
                        lRetorno.InformacoesPatrimoniais_TotalDeOutrosRendimentos = lInfo.VlTotalOutrosRendimentos.Value.ToString();
                    }
                    );
