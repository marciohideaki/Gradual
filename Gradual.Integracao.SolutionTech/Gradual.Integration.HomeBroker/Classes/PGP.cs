...
namespace Gradual.Integration.HomeBroker
{
    ...
    public class Crypto
    {
        ...
        */
        ...
        public static User Decrypt(byte[] inputData, Stream keyIn, string passCode)
        {
            return (User)ByteArrayToObject(DefaultDecrypt(inputData, keyIn, passCode));
        }
