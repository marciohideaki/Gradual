...
namespace Cortex.OMS.ServidorFIX
{
    ...
    public class ServidorFixConfig
    {
                /// <summary>
        ...
        /// <summary>
        /// Diretorio de gravacao do debug das threads dos clientes FIX
        /// </summary>
        ...
        /// </summary>
        public string DataDictionary42 { get; set; }
        public string DataDictionary44 { get; set; }
        public string DataDictionary50 { get; set; }
        ...
        /// </summary>
        //public string CancelOnDisconnect { get; set; }
