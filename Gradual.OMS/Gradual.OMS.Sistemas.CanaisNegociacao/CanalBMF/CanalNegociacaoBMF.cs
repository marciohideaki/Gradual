...
{
    public class CanalNegociacaoBMF : CanalNegociacaoBase
    {
        private HostFix<AplicacaoFixClienteBMF> _host = null;
        ...
        protected override void OnIniciar()
        {
            ...
            // Sobe o host fix
            _host = new HostFix<AplicacaoFixClienteBMF>(_config.ArquivoConfig, true);
            _host.AplicacaoFix.CanalBMF = this;
            _host.Iniciar();
        ...
        {
            // Faz o log
            Gradual.OMS.Library.Log.EfetuarLog("Finalizando canal BMF", LogTipoEnum.Passagem, ModulosOMS.ModuloCanais);
        ...
        protected override void OnProcessarMensagem(MensagemRequestBase mensagem)
        {
            ...
            QuickFix.Message mensagemFix = CanalNegociacaoBMFTradutor.Traduzir(this, mensagem);
