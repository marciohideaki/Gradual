...
namespace Orbite.RV.Sistemas.Integracao.BVMF
{
    ...
    public class ConversorCampoData : ConversorCampoBase
    {
        ...
        public ConversorCampoData() 
        {
            ...
            inicializaParametros(this.Parametros);
        }

        public ConversorCampoData(object parametros) : base(parametros)
        {
            inicializaParametros((ConversorCampoDataParametro)parametros);
        }
        ...
        private void inicializaParametros(ConversorCampoDataParametro parametros)
        {
            // Pega a string de formato
            string formato = parametros.FormatoData.ToLower();
