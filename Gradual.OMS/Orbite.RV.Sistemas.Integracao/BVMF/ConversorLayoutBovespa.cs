...
namespace Orbite.RV.Sistemas.Integracao.BVMF
{
    ...
    public class ConversorLayoutBovespa : IConversorLayoutBase
    {
        ...
        public ArquivoBVMFInfo InferirLayout(List<LayoutBVMFInfo> layouts, Stream stream, string nomeArquivo)
        {
            ...
            {
                // Pega tabela header
                LayoutBVMFTabelaInfo tabela = 
                    (from t in layout.Tabelas
                     where t.Parametros != null &&
                     ((ConversorLayoutBVMFParametroTabela)t.Parametros).TabelaTipo ==
                     ConversorLayoutBVMFParametroTabelaTipoEnum.Header
                ...
                if (tabela != null)
                {
                    ...
                    LayoutBVMFCampoInfo campo = 
                        (from c in tabela.Campos
