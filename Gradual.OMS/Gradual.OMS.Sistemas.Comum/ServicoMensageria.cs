        ...
        public MensagemResponseBase ProcessarMensagem(MensagemRequestBase parametros)
        {
            ...
            try
            {
                ...
                if (respostaValidacao.ContextoValidacao.MensagemValida)
                {
                    ...
                    Log.EfetuarLog("ServicoMensageria.ProcessarMensagem: " + Serializador.TransformarEmString(parametros), LogTipoEnum.Passagem, ModulosOMS.ModuloComum);
                }
                else
                {
                    // Cria resposta
                    ...
                    // Faz o log
                    Log.EfetuarLog("ServicoMensageria.ProcessarMensagem (Erro de Validação): " + Serializador.TransformarEmString(respostaValidacao), LogTipoEnum.Aviso, ModulosOMS.ModuloComum);
                }
            }
            catch (Exception ex)
            {
