...
using Gradual.OMS.Sistema.Automacao.Ordens;
...
namespace StopStartForms
{
    public partial class Form1 : Form
    {
        ...
        MDSEventFactory EventMds = new MDSEventFactory();
         ...
         ServicoAutomacaoOrdens _Ordens = new ServicoAutomacaoOrdens();
        ...
        private  void Initialize()
        {
            try
            {
                ...
                EventMds.OnMDSSRespostaSolicitacaoEvent
                    += new MDSEventFactory._OnMDSSRespostaSolicitacaoEvent(EventMds_OnMDSSRespostaSolicitacaoEvent);
            ...
            try
            {
                ...
                */
                ...
                if (StopStartTipo == StopStartTipoEnum.StopLoss)
                {
                    ...
                    ArmarStartStopResponse _Response = _Ordens.ArmarStopLoss(
                ...
                if (StopStartTipo == StopStartTipoEnum.StopGain)
                {
                    ...
                    ArmarStartStopResponse _Response = _Ordens.ArmarStopGain(
                          new ArmarStartStopRequest()
                          {
                              _AutomacaoOrdensInfo = _Order
                          });
                ...
                if (StopStartTipo == StopStartTipoEnum.StopSimultaneo)
                {
                    ...
                    ArmarStartStopResponse _Response = _Ordens.ArmarStopSimultaneo(
                          new ArmarStartStopRequest()
                          {
                              _AutomacaoOrdensInfo = _Order
                          });
                ...
                if (StopStartTipo == StopStartTipoEnum.StartCompra)
                {
                    ...
                    ArmarStartStopResponse _Response = _Ordens.ArmarStartCompra(
                      new ArmarStartStopRequest()
                      {
                          _AutomacaoOrdensInfo = _Order
                      });
        ...
        {   
            ...
            _Ordens.CancelaOrdemStopStart(int.Parse(txtIdStopStart.Text), (int)OrdemStopStatus.CancelamentoRegistradoAplicacao);
            ...
            CancelarStartStopOrdensResponse lRespostaCancelamento = new ServicoAutomacaoOrdens().CancelaOrdemStopStart(lRequestCancelamento);
