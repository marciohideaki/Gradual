...
namespace Gradual.OMS.Comunicacao.Automacao.Ordens.Mensagens.Enviadas
{
    public class SS_StopSimples : Header
    {
        ...
        public string IdStopStart{
            set { _IdStopStart = base.GetPosition(8, value, '0'); }
        ...
        public string getMessageSS(){
            ...
            return string.Format("{0}{1}{2}{3}{4}{5}", base.GetHeader("SS", this.tpBolsa,CodigoInstrumento), this.IdStopStart, this.IdTipoOrdem, this.PrecoLoss, this.PrecoGain, this.PrecoStart);
        }     
