...
namespace QuickFix
{
    namespace FIX44 
    {
        public class MarketDataSnapshotFullRefresh : Message
        {
            ...
            {
                public static int[] fieldOrder = {Tags.MDEntryType, Tags.MDBookType, Tags.MDStreamID, Tags.MarketDepth, Tags.StopPx, Tags.MDEntryPx, Tags.PriceType, Tags.MDEntryInterestRate, Tags.IndexSeq, Tags.Currency, Tags.MDEntrySize, Tags.MDEntryDate, Tags.MDEntryTime, Tags.MDInsertDate, Tags.MDInsertTime, Tags.TickDirection, Tags.MDMkt, Tags.TradingSessionID, Tags.SecurityTradingEvent, Tags.TradingSessionSubID, Tags.QuoteCondition, Tags.TradeCondition, Tags.MDEntryOriginator, Tags.LocationID, Tags.DeskID, Tags.OpenCloseSettlFlag, Tags.TimeInForce, Tags.ExpireDate, Tags.EarlyTermination, Tags.MaxTradeVol, Tags.ExpireTime, Tags.MinQty, Tags.ExecInst, Tags.SellerDays, Tags.SettlPriceType, Tags.LastTradeDate, Tags.PriceAdjustmentMethod, Tags.PriceBandType, Tags.PriceLimitType, Tags.LowLimitPrice, Tags.HighLimitPrice, Tags.TradingReferencePrice, Tags.PriceBandMidpointPriceType, Tags.AvgDailyTradedQty, Tags.OrderID, Tags.QuoteEntryID, Tags.MDEntryBuyer, Tags.MDEntrySeller, Tags.NumberOfOrders, Tags.MDEntryPositionNo, Tags.Scope, Tags.PriceDelta, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, Tags.UniqueTradeID, Tags.TradeID, Tags.TradeVolume, Tags.SecurityTradingStatus, Tags.NetChgPrevDay, Tags.Duration, Tags.NoReferentialPrices, Tags.TradSesOpenTime, Tags.RLCMsgID, Tags.MicrosecondOrderTimestamp, Tags.NoSharesIssued, 0};
