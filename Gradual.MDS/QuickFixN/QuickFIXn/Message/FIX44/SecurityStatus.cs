...
namespace QuickFix
{
    namespace FIX44 
    {
        public class SecurityStatus : Message
        {
            ...
            public QuickFix.Fields.BEITradingStatus BEITradingStatus
            { 
                get 
                {
                    QuickFix.Fields.BEITradingStatus val = new QuickFix.Fields.BEITradingStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.BEITradingStatus val) 
            { 
                this.BEITradingStatus = val;
            }
            
            public QuickFix.Fields.BEITradingStatus Get(QuickFix.Fields.BEITradingStatus val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.BEITradingStatus val) 
            { 
                return IsSetBEITradingStatus();
            }
            
            public bool IsSetBEITradingStatus() 
            { 
                return IsSetField(Tags.BEITradingStatus);
            }
