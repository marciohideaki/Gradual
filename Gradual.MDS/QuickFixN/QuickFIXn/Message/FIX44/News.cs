...
namespace QuickFix
{
    namespace FIX44 
    {
        public class News : Message
        {
            ...
            public News(
                    QuickFix.Fields.OrigTime aOrigTime,
                    QuickFix.Fields.Headline aHeadline,
                    QuickFix.Fields.NewsSource aNewsSource
                ) : this()
            {
                this.OrigTime = aOrigTime;
                this.Headline = aHeadline;
                this.NewsSource = aNewsSource;
            }
            ...
            public QuickFix.Fields.NewsSource NewsSource
            { 
                get 
                {
                    QuickFix.Fields.NewsSource val = new QuickFix.Fields.NewsSource();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NewsSource val) 
            { 
                this.NewsSource = val;
            }
            
            public QuickFix.Fields.NewsSource Get(QuickFix.Fields.NewsSource val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.NewsSource val) 
            { 
                return IsSetNewsSource();
            }
            
            public bool IsSetNewsSource() 
            { 
                return IsSetField(Tags.NewsSource);
            }
            ...
            public QuickFix.Fields.Language Language
            { 
                get 
                {
                    QuickFix.Fields.Language val = new QuickFix.Fields.Language();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.Language val) 
            { 
                this.Language = val;
            }
            
            public QuickFix.Fields.Language Get(QuickFix.Fields.Language val) 
            { 
                GetField(val);
                return val;
            }
            
            public bool IsSet(QuickFix.Fields.Language val) 
            { 
            ...
            { 
                return IsSetField(Tags.Language);
            }
            ...
            {
                public static int[] fieldOrder = {Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.SecurityExchange, Tags.InstrumentID, Tags.PutOrCall, Tags.NoSecurityAltID, Tags.Product, Tags.CFICode, Tags.SecurityGroupTMR, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.ExerciseStyle, Tags.OptAttribute, Tags.ContractMultiplier, Tags.CouponRate, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.SettlType, Tags.SettlDate, 0};
