...
namespace QuickFix.Fields
{
    ...
    public static class Tags
    {
        ...
        public const int ApplRespType = 1348;
        ...
        public const int ApplRespID = 1353;
        public const int ApplRespError = 1354;
        ...
        public const int SecurityGroupTMR = 1151;
        public const int MDStreamID = 1500;
        public const int RelSymTransactTime = 1504;
        public const int InternalSeqNo = 5024;
        public const int ExchangeQuoteID = 5001;
        public const int Memo = 5149;
        public const int TickSizeDenominator = 5151;
        public const int DaysToSettlement = 5497;
        public const int FixedRate = 5706;
        public const int OrderLinkID = 5975;
        public const int UniqueTradeID = 6032;
        public const int Duration = 6082;
        public const int IndexID = 6107;
        public const int TotalNumOfTrades = 6139;
        public const int ReferentialState = 6290;
        public const int IndexPct = 6919;
        public const int BTSRequesterIPAddress = 6928;
        public const int BTSRequesterOSIdentifier = 6929;
        public const int ApplicationLogonRspCode = 6930;
        public const int DaysBeforePwdExpiration = 6931;
        public const int NoReferentialPrices = 6932;
        public const int ReferentialPx = 6933;
        public const int ReferentialPxType = 6934;
        ...
        public const int PriceBandType = 6939;
        public const int NewsSource = 6940;
        public const int SecurityStrategyType = 7534;
        public const int NoSharesIssued = 7595;
        public const int StartSequence = 7174;
        public const int EndSequence = 7175;
        public const int InstrumentID = 9219;
        public const int LastTradeDate = 9325;
        public const int OmnibusAccount = 9701;
        public const int MaxOrderQty = 9748;
        public const int MinOrderQty = 9749;
        public const int OrigOrdQty = 9757;
        public const int SecurityGroup = 1151;
        public const int BusinessSeqNum = 10016;
        public const int ContextId = 10027;
        public const int BTSFinalTxOrdStatus = 10029;
        public const int SanityValidation = 10031;
        public const int OrigSecondaryOrderID = 10033;
        public const int LicenseRequestID = 10034;
        public const int Channel = 10035;
        public const int LicenseRequestStatus = 10038;
        public const int MicrosecondOrderTimestamp = 10052;
        public const int NoApplSeqNums = 10054;
        public const int RawDataOffset = 10055;
        public const int RLCMsgID = 10063;
        public const int ProtectionPrice = 35001;
        public const int CancelOnDisconnectType = 35002;
        public const int CODTimeoutWindow = 35003;
        public const int ExecuteUnderlyingTrade = 35004;
        public const int QuoteStatusReportType = 35005;
        public const int QuoteStatusResponseTo = 35006;
        public const int NoSupervisedIDs = 35007;
        public const int SupervisedID = 35008;
        public const int UserType = 35009;
        public const int ForceLogin = 35010;
        public const int SubUnitID = 35011;
        public const int InterfaceVersion = 35012;
        public const int UserAssignedIdentifier = 35013;
        public const int NoTradeIDs = 35014;
        public const int NoBroadCastIDs = 35015;
        public const int BroadCastID = 35016;
        public const int NoNewsAgencyIDs = 35017;
        public const int NewsAgencyID = 35018;
        public const int AdministrativeMessage = 35020;
        public const int ApplResponseStatus = 35021;
        public const int ExchangeOrderID = 35022;
        public const int ExchangeExecID = 35023;
        public const int LastPxInIssuedCurrency = 35024;
        public const int PriceInIssuedCurrency = 35025;
        public const int ExchangeSecondaryOrderID = 35026;
        public const int PossMissingApplMsg = 35033;
        public const int ControllerType = 35034;
        public const int InternalSeqNoVerID = 35035;
        public const int ProducerID = 35036;
        public const int MarketDate = 35046;
        public const int TraderCode = 35047;
        public const int BEITradingStatus = 35114;
        public const int AvgDailyTradedQty = 37003;
        public const int PriceBandMidpointPriceType = 37008;
        public const int CorporateActionEventID = 37010;
        public const int GovernanceIndicator = 37011;
        public const int PriceDivisor = 37012;
        public const int PriceAdjustmentMethod = 37013;
        public const int MDEntryInterestRate = 37014;
        public const int SecurityMatchType = 37015;
        public const int MDInsertDate = 37016;
        public const int MDInsertTime = 37017;
        public const int UnderlyingPxType = 37018;
        public const int EarlyTermination = 37019;
        public const int IndexTheoreticalQty = 37021;
        public const int NoSecurityGroups = 37022;
        public const int IndexSeq = 37100;
        public const int NoUserRoleIDs = 35038;
        public const int UserRoleID = 35039;
        public const int ControllerID = 35041;
        public const int IOIID = 23;
